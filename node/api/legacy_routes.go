...
// RegisterLegacyCompatibilityRoutes ???????????????
// ?????????????????????? 404???????????????
func RegisterLegacyCompatibilityRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("GET /api/v2/access-lists", func(w http.ResponseWriter, r *http.Request) {
		wmhttp.JSON(w, http.StatusNotImplemented, map[string]any{"code": "ERR", "details": map[string]string{"errCode": "MIGRATION_PENDING", "method": r.Method, "path": r.URL.Path}, "message": "???????"})
	})
	...
	mux.HandleFunc("GET /api/v2/workmesh/gateway/status", func(w http.ResponseWriter, r *http.Request) {
		wmhttp.JSON(w, http.StatusNotImplemented, map[string]any{"code": "ERR", "details": map[string]string{"errCode": "MIGRATION_PENDING", "method": r.Method, "path": r.URL.Path}, "message": "???????"})
	})
	...
	mux.HandleFunc("POST /api/v2/workmesh/gateway/login", func(w http.ResponseWriter, r *http.Request) {
		wmhttp.JSON(w, http.StatusNotImplemented, map[string]any{"code": "ERR", "details": map[string]string{"errCode": "MIGRATION_PENDING", "method": r.Method, "path": r.URL.Path}, "message": "???????"})
	})
	mux.HandleFunc("POST /api/v2/workmesh/gateway/register", func(w http.ResponseWriter, r *http.Request) {
		wmhttp.JSON(w, http.StatusNotImplemented, map[string]any{"code": "ERR", "details": map[string]string{"errCode": "MIGRATION_PENDING", "method": r.Method, "path": r.URL.Path}, "message": "???????"})
	})
	mux.HandleFunc("POST /api/v2/workmesh/gateway/unbind", func(w http.ResponseWriter, r *http.Request) {
		wmhttp.JSON(w, http.StatusNotImplemented, map[string]any{"code": "ERR", "details": map[string]string{"errCode": "MIGRATION_PENDING", "method": r.Method, "path": r.URL.Path}, "message": "???????"})
	})
