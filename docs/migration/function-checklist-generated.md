...
基线来源：旧 `apps/workmesh-node/core` 与 `agent` 全源码，生成时间：2026-08-30T07:59:02.056Z。
共 871 条接口：implemented 717、partial 76、pending 78。
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| partial | GET | `/api/v2/apps/:key` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| implemented | GET | `/api/v2/apps/checkupdate` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | - |
| partial | GET | `/api/v2/apps/detail/:appId/:version/:type` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/apps/detail/node/:appKey/:version` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/apps/details/:id` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/apps/icon/:key` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| implemented | GET | `/api/v2/apps/ignored/detail` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | - |
| partial | GET | `/api/v2/apps/installed/delete/check/:appInstallId` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/apps/installed/info/:appInstallId` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| implemented | GET | `/api/v2/apps/installed/list` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | - |
| partial | GET | `/api/v2/apps/installed/params/:appInstallId` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/apps/services/:key` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/apps/installed/check` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/apps/installed/conf` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/apps/installed/config/update` | apps/workmesh-server/node/api/apps.go | unknown | memory | present | 检测到固定空列表响应 |
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| partial | GET | `/api/v2/core/settings/apps/store/config` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/core/settings/interface` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/core/settings/memo` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
...
| partial | GET | `/api/v2/core/settings/ssl/info` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/core/settings/upgrade` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/core/settings/upgrade/releases` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
...
| partial | GET | `/api/v2/settings/snapshot/load` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
| implemented | GET | `/api/v2/settings/ssh/conn` | apps/workmesh-server/node/api/runtime_toolbox.go | unknown | memory | present | - |
| partial | GET | `/api/v2/settings/website/dir` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/core/settings/memo` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/core/settings/upgrade` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/settings/snapshot` | apps/workmesh-server/node/api/functional_domains.go | unknown | memory | present | 检测到固定空列表响应 |
