...
基线来源：旧 `apps/workmesh-node/core` 与 `agent` 全源码，生成时间：2026-08-30T08:36:09.583Z。
共 871 条接口：implemented 740、partial 53、pending 78。
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| implemented | GET | `/api/v2/ai/accounts/providers` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | GET | `/api/v2/ai/gpu/load` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | GET | `/api/v2/ai/gpu/options` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | GET | `/api/v2/ai/mcp/domain/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/counts` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/models` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/models/create` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/models/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/models/discover` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/models/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/accounts/verify` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/bind` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/channels` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/create` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/list` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/md/list` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/md/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/agent/unbind` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/batch/install` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/batch/operate` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/batch/skill/install` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/batch/upgrade` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/dingtalk/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/dingtalk/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/discord/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/discord/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/feishu/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/feishu/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/pairing/approve` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/qqbot/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/qqbot/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/telegram/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/telegram/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/wecom/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/wecom/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/weixin/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/channel/weixin/login` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/config-file/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/config-file/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/delete/check` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/hermes/chat/sessions` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/hermes/chat/sessions/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/hermes/chat/sessions/rename` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/model/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/model/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/other/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/other/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/overview` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugin/check` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugin/install` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugin/uninstall` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugin/upgrade` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugins/install` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugins/list` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugins/operate` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/plugins/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/remark` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/security/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/security/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/skills/install` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/skills/list` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/skills/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/skills/uninstall` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/skills/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/token/reset` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/website/bind` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/agents/website/unbind` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/domain/bind` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/domain/get` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/domain/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/gpu/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/domain/bind` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/domain/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server/connection/test` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server/del` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server/detail` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server/op` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server/status/sync` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/mcp/server/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/close` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/model` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/model/del` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/model/load` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/model/recreate` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/model/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/ollama/model/sync` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/tensorrt/create` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/tensorrt/delete` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/tensorrt/operate` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/tensorrt/search` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/ai/tensorrt/update` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
...
| partial | GET | `/api/v2/core/auth/passkey/list` | apps/workmesh-server/node/api/core_handlers.go | required | memory | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/core/auth/api/generate` | apps/workmesh-server/node/api/core_handlers.go | required | memory | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/core/auth/api/update` | apps/workmesh-server/node/api/core_handlers.go | required | memory | present | 检测到固定空列表响应 |
...
| implemented | POST | `/api/v2/core/auth/mfa/close` | apps/workmesh-server/node/api/core_handlers.go | required | memory | present | - |
...
| implemented | POST | `/api/v2/containers/list` | apps/workmesh-server/node/api/containers.go | unknown | database | missing | - |
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| implemented | GET | `/api/v2/cubesandbox/health` | apps/workmesh-server/node/api/ai_execution.go | public | database | present | - |
| implemented | GET | `/api/v2/cubesandbox/status` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/cubesandbox/reconcile` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/cubesandbox/start` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/cubesandbox/stop` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
...
| implemented | GET | `/api/v2/dashboard/quick/option` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | - |
...
| implemented | POST | `/api/v2/databases/common/info` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/common/load/file` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/common/update/conf` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
...
| implemented | POST | `/api/v2/databases/description/update` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/format/options` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/grants` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/grants/del` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/grants/search` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/grants/summary` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
...
| implemented | POST | `/api/v2/databases/remote` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/search` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/status` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/users` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/users/del` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/users/password` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/users/password/save` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/users/search` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/users/update` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/variables` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
| implemented | POST | `/api/v2/databases/variables/update` | apps/workmesh-server/node/api/database_routes.go | unknown | memory | missing | - |
...
| partial | GET | `/api/v2/files/recycle/status` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/files/share/check` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/files/share/download` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/files/share/info` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/files/share/qrcode` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/files/wget/process` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | GET | `/api/v2/files/wget/process/keys` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/ai-search` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/batch/check` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/batch/del` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/batch/role` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/check` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/chunkdownload` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/chunkupload` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/chunkupload/stop` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/compress` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/compress/stop` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| implemented | POST | `/api/v2/files/content` | apps/workmesh-server/node/api/files_routes.go | unknown | memory | present | - |
| partial | POST | `/api/v2/files/convert` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/convert/log` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/decompress` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/decompress/stop` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| implemented | POST | `/api/v2/files/del` | apps/workmesh-server/node/api/files_routes.go | required | memory | present | - |
| partial | POST | `/api/v2/files/depth/size` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/favorite` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/favorite/del` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/favorite/search` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/history/content` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/history/del` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/history/restore` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/history/search` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/mode` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/mount` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| implemented | POST | `/api/v2/files/move` | apps/workmesh-server/node/api/files_routes.go | required | memory | present | - |
| partial | POST | `/api/v2/files/move/stop` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/owner` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/preview` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/read/:type` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/recycle/clear` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/recycle/reduce` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/recycle/search` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/remark` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/remarks` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/files/share/create` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/share/del` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/share/detail` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/share/search` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
...
| partial | POST | `/api/v2/files/upload/search` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/user/group` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/wget` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
| partial | POST | `/api/v2/files/wget/stop` | apps/workmesh-server/node/api/files_routes.go | required | database | present | 检测到固定空列表响应 |
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| implemented | GET | `/api/v2/images/*filename` | apps/workmesh-server/cmd/workmesh-server/main.go | required | memory | present | - |
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| partial | GET | `/api/v2/process/:pid` | apps/workmesh-server/node/api/process.go | required | memory | present | 检测到固定空列表响应 |
...
| 状态 | 方法 | 路径 | 新实现 | 认证 | 持久化 | 测试 | 缺口 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| implemented | GET | `/api/v2/static/*filename` | apps/workmesh-server/cmd/workmesh-server/main.go | required | memory | present | - |
...
| implemented | GET | `/api/v2/websites/:id/config/:type` | apps/workmesh-server/node/api/website.go | required | database | present | - |
| implemented | GET | `/api/v2/websites/:id/https` | apps/workmesh-server/node/api/website.go | unknown | memory | present | - |
| pending | GET | `/api/v2/websites/:id/lbs` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/ca/:id` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/cors/:id` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/databases` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/default/html/:type` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | GET | `/api/v2/websites/monitor/config/global` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/proxy/config/:id` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/realip/config/:id` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | GET | `/api/v2/websites/resource/:id` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| implemented | GET | `/api/v2/websites/rewrite/custom` | apps/workmesh-server/node/api/website.go | required | memory | present | - |
| implemented | GET | `/api/v2/websites/ssl/:id` | apps/workmesh-server/node/api/ssl.go | unknown | database | missing | - |
...
| pending | POST | `/api/v2/websites/acme/del` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/acme/search` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/acme/update` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/auths` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/auths/path` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/auths/path/update` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/auths/update` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/batch/group` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/batch/operate` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/batch/ssl` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/ca/del` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/ca/download` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/ca/obtain` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/ca/renew` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/ca/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/cors/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/crosssite` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/databases` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/default/html/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/default/server` | apps/workmesh-server/node/api/legacy_routes.go | required | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/dns/del` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/dns/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/dns/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/exec/composer` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/group/change` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/lbs/create` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/lbs/del` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/lbs/file` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/lbs/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/log/operate` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/log/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/config/global` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/config/site` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/config/site/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/logs/clear` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/logs/detail` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/logs/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/logs/stat` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/qps` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/rank` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/stat` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/trend` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/visitors` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/visitors/loc` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/monitor/websites` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/php/version` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/proxies` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/proxies/delete` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/proxies/file` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/proxies/status` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/proxies/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/proxy/clear` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/stream/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/del` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/get` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/outputs` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/outputs/del` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/outputs/get` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/outputs/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/preview` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/update` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/templates/upload` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| pending | POST | `/api/v2/websites/waf/attack/stat` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/waf/block/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| implemented | POST | `/api/v2/websites/waf/global` | apps/workmesh-server/node/api/website.go | unknown | memory | present | - |
| pending | POST | `/api/v2/websites/waf/log/search` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
| pending | POST | `/api/v2/websites/waf/relation/stat` | apps/workmesh-server/node/api/legacy_routes.go | unknown | memory | missing | 返回 501/MIGRATION_PENDING 或 StatusNotImplemented |
...
| implemented | POST | `/api/v2/workmesh/tasks/cancel` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/workmesh/tasks/collect` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/workmesh/tasks/create` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/workmesh/tasks/destroy` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/workmesh/tasks/exec` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
| implemented | POST | `/api/v2/workmesh/tasks/start` | apps/workmesh-server/node/api/ai_execution.go | required | database | present | - |
...
| implemented | GET | `/api/v2/xpack/waf/sites/:id/rules` | apps/workmesh-server/node/api/website.go | required | database | present | - |
