...
const managedChainName = computed(() => (props.currentTab === 'forward' ? 'WORKMESH_FORWARD' : 'WORKMESH_BASIC'));
...
const onBind = async () => {
    ...
    await operateFilterChain('WORKMESH_BASIC', 'bind-base');
    MsgSuccess(i18n.global.t('commons.msg.operationSuccess'));
    await loadBaseInfo(true);
};
...
const onUnBind = async () => {
    ...
    await operateFilterChain('WORKMESH_BASIC', 'unbind-base');
    MsgSuccess(i18n.global.t('commons.msg.operationSuccess'));
    await loadBaseInfo(true);
};
