...
const defaultLoginImage = new URL('@/assets/images/workmesh-login.jpg', import.meta.url).href;
const defaultEnterpriseLoginImage = new URL('@/assets/images/workmesh-login-enterprise.png', import.meta.url).href;
const defaultLoginBgImage = new URL('@/assets/images/workmesh-login-bg.jpg', import.meta.url).href;
