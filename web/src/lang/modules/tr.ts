...
const message = {
    ...
    menu: {
        ...
        waf: 'WAF',
        multiNode: 'Çoklu Düğüm Yönetimi',
    ...
    home: {
        ...
        restart_workmesh: 'Paneli yeniden başlat',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Yalnızca mevcut parolayı WorkMesh içine kaydeder; MySQL parolasını değiştirmez.',
        ...
        loadFromRemoteHelper:
            'Sunucudaki veritabanlarını, kullanıcıları ve yetkilendirmeleri WorkMesh ile eşitler. Devam edilsin mi?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Bu model WorkMesh aracılığıyla indirilmedi, ilgili çekme logları yok.',
        ...
        benchmark: {
            ...
            endpoint: 'Endpoint',
            tokenizer: 'Tokenizer',
            tokenizerPlaceholder: 'Yerel tokenizer dizini seçin veya girin, örn. /opt/workmesh/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Bağımsız değişkenler supergateway komutuna eklenir. WorkMesh tarafından yönetilen aktarım, bağlantı noktası, yol ve protokol bağımsız değişkenleri değiştirilemez',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Kapsayıcının Uygulama Mağazası'ndan geldiği tespit edildi. Kapsayıcıyı silmek, onu WorkMesh'den tamamen kaldırmaz. Tamamen silmek için lütfen Uygulama Mağazası -> 'Yüklü' veya 'Çalışma Ortamı' menülerine gidin. Devam edilsin mi?",
        start: 'Başlat',
        stop: 'Durdur',
        restart: 'Yeniden başlat',
        kill: 'Öldür',
        ...
        composeHelper:
            'WorkMesh editörü veya şablonu aracılığıyla oluşturulan kompozisyon {0}/docker/compose dizinine kaydedilecektir.',
        ...
        composeDetailHelper: 'Compose, WorkMesh dışında oluşturulmuştur. Başlatma ve durdurma işlemleri desteklenmez.',
        ...
        composeEnvHelper2:
            'Bu düzenleme WorkMesh Uygulama Mağazası tarafından oluşturuldu. Lütfen ortam değişkenlerini yüklü uygulamalarda değiştirin.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Döndürülen log dosyaları WorkMesh yedek dizinine yedeklenecektir.',
        ...
        logHelper1: '1. WorkMesh sistem günlüğü',
    ...
    file: {
        ...
        clashDidNotSupport: 'Dosya adlarının .workmesh_clash içermesi yasaktır',
        ...
        panelInstallDir: 'WorkMesh kurulum dizini silinemez',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Saat dilimi değişikliği, sistem timedatectl servisine bağlıdır. WorkMesh servisi yeniden başlatıldıktan sonra etkili olur.',
        timeZoneCN: 'Pekin',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'WorkMesh alan adı bağlama yapılandırıldı',
        ...
        bindDomainHelper: 'Alan adı bağlandıktan sonra, yalnızca o alan adı WorkMesh servisine erişebilir.',
        bindDomainHelper1: 'Alan adı bağlamasını devre dışı bırakmak için boş bırakın.',
        bindDomainWarning:
            'Alan adı bağlamasından sonra oturumunuz kapatılacak ve yalnızca ayarlarınızda belirtilen alan adı üzerinden WorkMesh servisine erişebilirsiniz. Devam etmek istiyor musunuz?',
        allowIPs: 'Yetkili IP',
        ...
        mfaTitleHelper:
            'Başlık, farklı WorkMesh ana bilgisayarlarını ayırt etmek için kullanılır. Başlığı değiştirdikten sonra QR kodunu tekrar tarayın veya gizli anahtarı manuel olarak ekleyin.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Bu kural, anlık görüntü oluştururken WorkMesh veri dizinini sıkıştırmak ve yedeklemek için kullanılacaktır. Varsayılan olarak, soket dosyaları yok sayılır.',
        ignoreHelper1: 'Her satıra bir tane. Örneğin,\n*.log\n/opt/workmesh/cache',
        panelInfo: 'WorkMesh temel bilgilerini yaz',
        panelBin: 'WorkMesh sistem dosyalarını yedekle',
        daemonJson: 'Docker yapılandırma dosyasını yedekle',
        appData: 'WorkMesh’den yüklenen uygulamaları yedekle',
        panelData: 'WorkMesh veri dizinini yedekle',
        backupData: 'WorkMesh için yerel yedekleme dizinini yedekle',
        ...
        recoverHelper1: 'Kurtarma, Docker ve WorkMesh servislerinin yeniden başlatılmasını gerektirir',
        recoverHelper2:
        ...
        rollback: 'Geri al',
        rollbackHelper:
            'Bu kurtarmayı geri almak, bu kurtarmadan gelen tüm dosyaları değiştirecek ve Docker ile WorkMesh servislerinin yeniden başlatılmasını gerektirebilir. Devam etmek istiyor musunuz?',
        upgradeRecord: 'Yükseltme kaydı',
        upgrading: 'Yükseltiliyor, lütfen bekleyin...',
        upgradeHelper: 'Yükseltme, WorkMesh servisinin yeniden başlatılmasını gerektirir. Devam etmek istiyor musunuz?',
        ...
        rollbackLocalHelper:
            'Birincil düğüm doğrudan geri almayı desteklemez. Lütfen geri almak için [wh restore] komutunu manuel olarak çalıştırın!',
    ...
    license: {
        ...
        node: 'Ticari sürüme yükselterek WorkMesh ile birden fazla Linux sunucusunu yönetebilirsiniz.',
        nodeApp:
        ...
        vllm: 'Ticari sürüme yükselterek vLLM hizmetlerini WorkMesh içinde merkezi olarak dağıtabilir, yapılandırabilir, yaşam döngüsünü yönetebilir ve görevleri izleyebilirsiniz.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'WorkMesh çalışma zamanında üretilen gereksiz dosyaları kolayca temizleyin',
        clean: 'Şimdi temizle',
        reScan: 'Yeniden tara',
    ...
    ssl: {
        ...
        shell: 'Betik içeriği',
        shellHelper:
            'Betiğin varsayılan yürütme dizini, WorkMesh kurulum dizinidir. Sertifika yerel dizine aktarılırsa, yürütme dizini sertifika aktarma dizini olacaktır. Varsayılan yürütme zaman aşımı 30 dakikadır.',
    ...
    firewall: {
        ...
        managedHelper: 'WorkMesh tarafından oluşturulur ve yönetilir. Düzenlenebilir veya silinebilir.',
        adopted: 'Harici yönetilen',
        adoptedHelper: 'Önceden sistemde bulunan ve artık WorkMesh tarafından yönetilen bir kuraldır.',
        external: 'Harici kural',
        externalHelper:
            'Sistemde bulunan ancak henüz WorkMesh tarafından yönetilmeyen bir kuraldır. Gerektiğinde yönetime alınabilir.',
        ...
        adoptRuleConfirm: 'Devraldıktan sonra WorkMesh bu mevcut kuralı yönetebilir ve silebilir. Devam edilsin mi?',
        ...
        plan_equivalent_managed_rule: 'Aynı kural zaten WorkMesh tarafından yönetiliyor. Kopya gerekmez.',
        ...
        scopeUnmanagedActive: 'Başka etkin kapsamlar algılandı: {0}. WorkMesh bunların kurallarını değiştirmez.',
        ...
        dockerFirewallHelper: 'WorkMesh konteyner portu korumasının nasıl yönetileceğini seçer.',
        ...
        resetDirectRulesHelper:
            '{0} içindeki WorkMesh sistem güvenlik duvarı zincirlerini, çalışma zamanı kurallarını ve kalıcı dosyaları silin; veritabanı ilkelerini koruyun',
        ...
        cleanupForwardingBackendHelper:
            '{0} içindeki WorkMesh bağlantı noktası yönlendirme çalışma zamanı kurallarını sıfırlayın: ilgili tüm kuralları ve zincirleri silip veritabanı verilerini koruyun',
        cleanupDockerBackendHelper:
            '{0} içindeki WorkMesh Docker bağlantı noktası koruma çalışma zamanı kurallarını sıfırlayın: ilgili tüm kuralları ve zincirleri silip veritabanı verilerini koruyun',
        cleanupBeforeBackendSwitch:
            'Mevcut {0} arka ucu hâlâ WorkMesh çalışma zamanı kuralları içeriyor. {1} arka ucuna geçmeden önce sıfırlayın.',
        ...
        ruleSyncHelper:
            'Seçilen güvenlik duvarındaki WorkMesh yönetimli kuralları mevcut güvenlik duvarıyla eşitler. Kaynak kurallar silinmez ve harici kurallar eşitlenmez.',
        ruleSyncDatabase: 'WorkMesh veritabanı',
        ruleSyncDatabaseHelper:
            'Mevcut güvenlik duvarındaki yönetilen kuralları WorkMesh veritabanı kurallarına göre eşitler ve uyumlu hale getirir. Eksik kurallar eklenir, fazla kurallar silinir.',
        ...
        clearDockerGuardPoliciesConfirm:
            'Seçilen uç noktalar Docker varsayılan erişim davranışına döner. Devam edilsin mi?',
        protection: 'Koruma',
        ...
        allowedSources: 'İzin verilen kaynaklar',
        dockerGuardPolicy: 'Konteyner portu koruma ilkesi',
        ...
        dockerGuardStatusReason: {
            ...
            docker_chain_missing:
                '{0} için Docker konteyner ağı etkin değil, bu nedenle ilgili koruma gerekli değildir. Gerekirse önce Docker içinde {0} özelliğini etkinleştirin',
            guard_chain_missing: '{0} port koruması tam olarak başlatılmadı. Yeniden başlatın',
            jump_missing: '{0} port koruması bağlı değil ve şu anda etkin değil. Yeniden bağlayın',
            jump_not_first:
                '{0} port koruması yanlış yapılandırılmış ve tam çalışmayabilir. Bağı kaldırıp yeniden bağlayın',
            jump_duplicate: '{0} port korumasında yinelenen yapılandırma var. Bağı kaldırıp yeniden bağlayın',
            inspect_failed: '{0} port koruması durumu alınamıyor. Yenileyin veya sistem güvenlik duvarını kontrol edin',
        },
        dockerGuardUnprotected: 'Korunmuyor',
        ...
        directBackendConflictWarning:
            '{0} ve {1} aynı anda bağlı olduğundan iki kural kümesi de etkindir. Birbirlerini engellemediklerini doğrulayın ve artık kullanmadığınız güvenlik duvarının bağlantısını el ile kaldırın.',
        initHelper:
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Bu, ana yapılandırma dosyasındaki "[include]" bölümündeki "files" değerini değiştirecektir. Diğer yapılandırma dosyasının dizini şu şekilde olacaktır: "{WorkMesh kurulum dizini}/workmesh/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Kimlik sağlayıcı ile WorkMesh arasındaki küçük zaman farklarına izin verir. Varsayılan 60 saniyeyi koruyun.',
                    ...
                    standardDiscoveryDesc: 'WorkMesh uç noktaları ve yetenekleri keşfeder ve ham belgeyi saklamaz.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Bu özniteliği doğrulanmış SAML Assertion içinden okur ve WorkMesh kullanıcı adına eşler.',
                    ...
                    syncLogoutHelper:
                        "WorkMesh'den veya kimlik sağlayıcıdan çıkış yapmak diğer taraftaki oturumu da kapatır.",
                    testBeforeBrowserTest:
                        'Tarayıcı oturum açma testine başlamadan önce mevcut yapılandırmayı test edin.',
                    testBeforeEnable:
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Kullanıcı arama tabanını ve filtreyi ayarlayın, ardından WorkMesh name olarak kullanılan LDAP niteliğini eşleyin.',
                    ...
                    attributeMapTooltip: 'JSON, WorkMesh name alanından bir LDAP özniteliğine eşleme.',
                    attributeMapHelper: 'WorkMesh name alanına eşlenen LDAP niteliğini ayarlayın.',
                    advanced: 'Gelişmiş ayarlar',
                    ...
                    sync: {
                        ...
                        description:
                            "LDAP dizininin tamamını bir programa göre okuyun ve WorkMesh'da içe aktarılan LDAP kullanıcılarını koruyun.",
                    ...
                    testLoginDesc:
                        'Yalnızca kimlik doğrulamayı test etmek için AD/LDAP kullanıcı kimlik bilgileriyle bağlantı kurun. WorkMesh oturumu oluşturulmadı.',
        ...
        waf: {
           WAF: 'WAF',
            time: 'Zaman',
            runtimeUnavailable: 'WAF çalışma ortamı kullanılamıyor. Önce ModSecurity ve CRS içeren bir OpenResty imajı yükleyin.',
            name: 'WAF',
        ...
        helper: {
            ...
            settingContent1: 'WorkMesh giriş sayfasında özel bir hoş geldiniz mesajı ayarlayın.',
            ...
            appContent1: 'WorkMesh sunucunuzu her zaman, her yerde kolayca yönetin.',
            ...
            vllmContent1:
                "Dağıtık vLLM örneklerini WorkMesh'e entegre edin ve sürümleri, çalışma durumlarını ve çalışma dizinlerini merkezi olarak yönetin.",
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Yalnızca `workmesh-agent_v*_*` veya `workmesh-v*-linux-*` kurulum paketleri desteklenir',
            ...
            panelExist:
                'Bu düğümde WorkMesh V1 hizmeti çalıştığı algılandı. Lütfen eklemeden önce geçiş betiğini kullanarak V2’ye yükseltin.',
            coreExist:
            ...
            agentExist:
                'Bu düğümde workmesh-agent’ın zaten kurulu olduğu algılandı. Devam edilmesi mevcut verileri koruyacak ve yalnızca workmesh-agent hizmetini değiştirecektir.',
            agentNotExist:
                'Bu düğümde workmesh-agent yüklü olmadığı tespit edildi, düğüm bilgileri doğrudan düzenlenemez. Lütfen silip tekrar ekleyin.',
            oldDataExist:
                'Bu düğümde geçmiş WorkMesh V2 verileri algılandı. Aşağıdaki bilgiler mevcut ayarları üzerine yazmak için kullanılacaktır:',
            ...
            fixStatus:
                'Hizmetin çalıştığından emin olmak için "systemctl status workmesh-agent.service" komutunu çalıştırın.',
            ...
            uninstallHelper: 'Bu, düğümle ilgili tüm WorkMesh verilerini silecektir. Dikkatli ilerleyin!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'İşlev: Görüntü önekini özelleştirir ve compose dosyasındaki görüntü alanını değiştirir. Örneğin, görüntü öneki workmesh/custom olarak ayarlandığında, MaxKB için görüntü alanı workmesh/custom/maxkb:v1.10.0 olarak değişir',
