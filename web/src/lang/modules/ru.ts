...
const message = {
    commons: {
        ...
        login: {
            ...
            agreeContent:
                'Для лучшей защиты ваших законных прав и интересов, пожалуйста, прочитайте и согласитесь со следующим соглашением &laquo; <a href = "https://www.workmesh.com/legal/licenses.html" target = "_blank" > Лицензионное соглашение сообщества </a> &raquo;',
    ...
    home: {
        ...
        restart_workmesh: 'Перезапустить панель',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Сохраняет текущий пароль только в WorkMesh и не изменяет пароль в MySQL.',
        ...
        loadFromRemoteHelper: 'Синхронизировать базы данных, пользователей и права доступа с сервера в WorkMesh?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Эта модель не была загружена через WorkMesh, нет связанных журналов извлечения.',
        ...
        aiProxy: {
            ...
            autoModelName: 'Имя модели умной маршрутизации',
            autoModelNameHelper:
                'Запросы с этим именем модели используют умную маршрутизацию. Не используйте имя реальной модели.',
            smartRouteGuideTitle: 'Используйте model={0} на клиенте для умной маршрутизации',
            smartRouteGuideReady:
                'model={0} выбирает простую или сложную группу моделей по сложности запроса. Любая другая модель пересылается обычным AI-шлюзом.',
            smartRouteGuideNotReady:
                'Сначала включите умную маршрутизацию и настройте простую/сложную группы моделей. Затем используйте model={0} на клиенте.',
            copyAutoModel: 'Копировать имя модели',
            ...
            smartRouteSettingGuide:
                'После включения только запросы с model={0} запускают умную маршрутизацию. Простая группа — для дешевых задач, сложная — для анализа кода, проектирования архитектуры и диагностики.',
        ...
        skillsHub: {
            ...
            customTarget: 'Каталог Skill агента',
            installToTarget: 'Установить в каталог Skill агента',
            ...
            deleteTargetConfirm:
                'Удалить эту конфигурацию каталога Skill агента? Пользователи больше не смогут выбрать этот каталог установки.',
            noInstallTarget: 'Нет доступных каталогов Skill агента. Сначала добавьте каталог.',
            postInstallConfirm:
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Выберите или введите локальный каталог токенизатора, например /opt/workmesh/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Аргументы добавляются к команде supergateway. Параметры транспорта, порта, пути и протокола, управляемые WorkMesh, изменить нельзя',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Обнаружено, что контейнер создан из Магазина приложений. Удаление контейнера не удалит его полностью из WorkMesh. Для полного удаления перейдите в Магазин приложений -> меню 'Установленные' или 'Среда выполнения'. Продолжить?",
        start: 'Запустить',
        stop: 'Остановить',
        restart: 'Перезапустить',
        kill: 'Завершить',
        ...
        composeHelper:
            'Композиция, созданная через редактор WorkMesh или шаблон, будет сохранена в директории {0}/docker/compose.',
        ...
        composeDetailHelper: 'Compose создан вне WorkMesh. Операции запуска и остановки не поддерживаются.',
        ...
        composeEnvHelper2:
            'Эта оркестрация создана Магазином приложений WorkMesh. Измените переменные среды в установленных приложениях.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Ротированные файлы логов будут сохранены в директории резервных копий WorkMesh.',
        ...
        logHelper1: '1. Системный лог WorkMesh',
    ...
    file: {
        ...
        clashDidNotSupport: 'Имена файлов не должны содержать .workmesh_clash',
        ...
        panelInstallDir: 'Директорию установки WorkMesh нельзя удалить',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Изменение часового пояса зависит от системной службы timedatectl. Вступит в силу после перезапуска службы WorkMesh.',
        timeZoneCN: 'Пекин',
        timeZoneAM: 'Лос-Анджелес',
        timeZoneNY: 'Нью-Йорк',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Настроена привязка домена WorkMesh',
        ...
        bindDomainHelper: 'После привязки домена только этот домен сможет получить доступ к службе WorkMesh.',
        bindDomainHelper1: 'Оставьте пустым, чтобы отключить привязку доменного имени.',
        bindDomainWarning:
            'После привязки домена вы будете выходить из системы и сможете получить доступ к службе WorkMesh только через указанное в настройках доменное имя. Хотите продолжить?',
        ...
        mfaTitleHelper:
            'Заголовок используется для различения разных хостов WorkMesh. Отсканируйте снова или вручную добавьте секретный ключ после изменения заголовка.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Это правило будет использоваться для сжатия и резервного копирования директории данных WorkMesh при создании снапшота. По умолчанию игнорируются файлы сокетов.',
        ignoreHelper1: 'По одному в строке. Например,\n*.log\n/opt/workmesh/cache',
        panelInfo: 'Записать базовую информацию WorkMesh',
        panelBin: 'Резервное копирование системных файлов WorkMesh',
        daemonJson: 'Резервное копирование конфигурационного файла Docker',
        appData: 'Резервное копирование установленных приложений из WorkMesh',
        panelData: 'Резервное копирование директории данных WorkMesh',
        backupData: 'Резервное копирование локальной директории резервных копий для WorkMesh',
        ...
        recoverHelper1: 'Восстановление требует перезапуска служб Docker и WorkMesh',
        recoverHelper2:
        ...
        rollback: 'Откатить',
        rollbackHelper:
            'Откат этого восстановления заменит все файлы из этого восстановления и может потребовать перезапуска служб Docker и WorkMesh. Хотите продолжить?',
        upgradeHelper: 'Обновление требует перезапуска службы WorkMesh. Хотите продолжить?',
        rollbackLocalHelper:
            'Основной узел не поддерживает прямой откат. Пожалуйста, вручную выполните команду [wh restore] для отката!',
    ...
    license: {
        ...
        securityWarningContent:
            'WorkMesh должен запускаться пользователем с правами системного администратора. Неофициальные лицензии или измененные сборки могут привести к потере контроля над сервером, утечке данных и другим серьезным рискам безопасности. Получайте лицензии и установочные пакеты только через официальные каналы workmesh.',
        ...
        node: 'Обновление до коммерческой редакции позволяет управлять несколькими серверами Linux с помощью WorkMesh.',
        nodeApp:
        ...
        vllm: 'Обновите до коммерческой версии, чтобы централизованно управлять сервисами vLLM в WorkMesh: развертыванием, настройкой, жизненным циклом и отслеживанием задач.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'Легко очищайте мусорные файлы, созданные во время работы WorkMesh',
    ...
    ssl: {
        ...
        shellHelper:
            'Директория выполнения скрипта по умолчанию - директория установки WorkMesh. Если сертификат отправляется в локальную директорию, директорией выполнения будет директория отправки сертификата. Тайм-аут выполнения по умолчанию - 30 минут.',
    ...
    firewall: {
        ...
        managedHelper: 'Создано и поддерживается WorkMesh. Правило можно изменить или удалить.',
        adopted: 'Внешнее под управлением',
        adoptedHelper: 'Существующее системное правило, которое теперь поддерживается WorkMesh.',
        external: 'Внешнее правило',
        externalHelper:
            'Существующее системное правило, которое пока не управляется WorkMesh. При необходимости его можно принять под управление.',
        ...
        adoptRuleConfirm: 'После этого WorkMesh сможет обслуживать и удалять существующее правило. Продолжить?',
        ...
        plan_equivalent_managed_rule: 'Такое правило уже управляется WorkMesh. Дубликат не требуется.',
        ...
        scopeUnmanagedActive: 'Обнаружены другие активные области: {0}. WorkMesh не будет изменять их правила.',
        ...
        dockerFirewallHelper: 'Выбирает способ управления защитой портов контейнеров в WorkMesh.',
        dockerNftablesRequirement: 'Docker ≥ 29.0.0, экспериментально',
        backendRecommendation: 'Рекомендуется использовать iptables или nftables.',
        configuredRules: 'Настроено правил: {0}',
        addressFamily: 'Версия IP',
        portOrRange: 'Порт / диапазон',
        exportAllRules: 'Экспортировать все правила',
        importBackendHelper:
            'Импортируемые правила преобразуются для текущего бэкенда {0}. Исходные правила не изменяются.',
        resetDirectRulesHelper:
            'Удалить из {0} системные цепочки, действующие правила и постоянные файлы WorkMesh; политики в базе данных сохраняются',
        ...
        cleanupForwardingBackendHelper:
            'Сбросить правила времени выполнения переадресации портов WorkMesh в {0}: удалить все связанные правила и цепочки, сохранив данные в базе данных',
        cleanupDockerBackendHelper:
            'Сбросить правила времени выполнения защиты портов Docker WorkMesh в {0}: удалить все связанные правила и цепочки, сохранив данные в базе данных',
        cleanupBeforeBackendSwitch:
            'Текущий бэкенд {0} всё ещё содержит правила времени выполнения WorkMesh. Сбросьте его перед переключением на {1}.',
        ...
        ruleSyncAction: 'Синхронизировать правила',
        ruleSyncHelper:
            'Синхронизирует правила WorkMesh из выбранного брандмауэра с текущим. Исходные правила не удаляются, а внешние правила не синхронизируются.',
        ruleSyncDatabase: 'База данных WorkMesh',
        ruleSyncDatabaseHelper:
            'Синхронизирует и приводит управляемые правила текущего межсетевого экрана в соответствие с правилами из базы данных WorkMesh. Недостающие правила будут добавлены, а лишние — удалены.',
        ruleSyncDatabaseTotal: 'Правила базы данных',
        ruleSyncDatabaseConfirm:
            'Синхронизировать {1} в точном соответствии с {0} правилами базы данных? Будет удалено {2} правил на целевой стороне, а недостающие будут добавлены.',
        ruleSyncSource: 'Источник конфигурации',
        ruleSyncTarget: 'Текущий бэкенд',
        ruleSyncTotal: 'Преобразованные правила',
        ruleSyncReady: 'Готово',
        ruleSyncExisting: 'Уже существует',
        ruleSyncRemove: 'К удалению',
        ...
        ruleSyncConfirm: 'Синхронизировать {0} правил из {1} в {2}? Исходный бэкенд не будет изменён.',
        ruleSyncResetSource: 'После синхронизации сбросить и отключить исходный брандмауэр {0}',
        ruleSyncResetSourceHelper: 'Источник сбрасывается только после успешной синхронизации всех правил.',
        ruleSyncResetSourceBlocked: 'Некоторые правила нельзя синхронизировать. Сначала устраните проблемы.',
        ruleSyncResetSourceConfirm:
            'Синхронизировать {0} правил из {1} в {2}, затем сбросить и отключить {1}? Вся его конфигурация будет удалена без возможности восстановления.',
        ...
        selectedBackendNotInstalled:
            'Служба {backend} не обнаружена. Установите её вручную из {library} или переключите бэкенд межсетевого экрана в разделе {settings}.',
        initializedStatus: 'Инициализировано',
        partiallyInitialized: 'Частично инициализировано',
        dockerGuardHelper:
            'Настройте ограничения доступа к портам, опубликованным контейнерами Docker на хосте. Незащищенные порты сохраняют стандартный режим доступа Docker.',
        ...
        clearDockerGuardPoliciesConfirm:
            'Выбранные конечные точки вернутся к стандартному режиму доступа Docker. Продолжить?',
        protection: 'Защита',
        ...
        allowedSources: 'Разрешенные источники',
        dockerGuardPolicy: 'Политика защиты портов контейнеров',
        ...
        dockerGuardInconsistentConfigHelper:
            'Выбранные правила имеют разные настройки. Задайте их заново, чтобы перезаписать все; пустое описание очистит описания у всех правил.',
        effective: 'Действует',
        ...
        dockerGuardStatusReason: {
            command_missing:
                'Компонент межсетевого экрана {0} недоступен, поэтому соответствующую защиту нельзя включить. Проверьте системный межсетевой экран',
            docker_chain_missing:
                'Сеть контейнеров Docker для {0} не включена, поэтому соответствующая защита не требуется. При необходимости сначала включите {0} в Docker',
            guard_chain_missing: 'Защита портов {0} инициализирована не полностью. Выполните инициализацию еще раз',
            jump_missing: 'Защита портов {0} не привязана и не действует. Выполните привязку еще раз',
            jump_not_first:
                'Защита портов {0} настроена неверно и может работать не полностью. Отвяжите и привяжите ее снова',
            jump_duplicate: 'В конфигурации защиты портов {0} есть дубликаты. Отвяжите и привяжите ее снова',
            inspect_failed:
                'Не удалось получить состояние защиты портов {0}. Обновите страницу или проверьте системный межсетевой экран',
        },
        dockerGuardUnprotected: 'Не защищено',
        ...
        initDirectBackendConflictMsg:
            '{1} всё ещё привязан. После инициализации {0} оба набора правил будут активны и могут неожиданно заблокировать доступ. Продолжить?',
        directBackendConflictWarning:
            '{0} и {1} одновременно привязаны, поэтому действуют оба набора правил. Убедитесь, что они не блокируют друг друга, и вручную отвяжите неиспользуемый межсетевой экран.',
        initHelper:
        ...
        deleteUsedRuleConfirm:
            'Это правило охватывает слушающие сервисы, предоставляемые {0}. Его удаление может сделать эти сервисы недоступными. Продолжить?',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Это изменит значение "files" в секции "[include"] в основном конфигурационном файле. Директория других конфигурационных файлов будет: "{директория установки WorkMesh}/workmesh/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Допускает небольшую разницу времени между поставщиком удостоверений и WorkMesh. Оставьте значение по умолчанию 60 секунд.',
                    ...
                    panelURL: 'WorkMesh общедоступный URL',
                    panelURLHTTPWarning:
                        'HTTP не ​​защищает ответ авторизации. Используйте его только в изолированной частной среде, разрешенной Provider.',
                    panelURLHelper:
                        'Укажите адрес, по которому пользователи открывают WorkMesh. Он используется для формирования URL обратного вызова.',
                    panelURLInvalid: 'Введите источник, содержащий только схему, хост и дополнительный порт.',
                    panelURLRequired: 'Введите общедоступный WorkMesh URL.',
                    ...
                    standardDiscoveryDesc:
                        'WorkMesh обнаруживает конечные точки и возможности и не сохраняет необработанный документ.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Считывает этот атрибут из проверенного SAML Assertion и сопоставляет его с именем пользователя WorkMesh.',
                    ...
                    syncLogoutHelper: 'Выход из WorkMesh или IdP также завершает сеанс на другой стороне.',
                    testBeforeBrowserTest: 'Проверьте текущую конфигурацию перед запуском проверки входа в браузер.',
                    testBeforeEnable:
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Установите базу поиска пользователей и фильтр, затем сопоставьте атрибут LDAP, используемый как WorkMesh name.',
                    ...
                    attributeMapTooltip: 'Сопоставление JSON поля WorkMesh name с атрибутом LDAP.',
                    attributeMapHelper: 'Установите атрибут LDAP, сопоставленный с полем WorkMesh name.',
                    advanced: 'Расширенные настройки',
                    ...
                    sync: {
                        ...
                        description:
                            'Чтение полного каталога LDAP по расписанию и поддержка импортированных пользователей LDAP в WorkMesh.',
                    ...
                    testLoginDesc:
                        'Привяжите учетные данные пользователя AD/LDAP только для проверки аутентификации. Сеанс WorkMesh не создается.',
        ...
        waf: {
           WAF: 'WAF',
            time: 'Время',
            runtimeUnavailable: 'Среда выполнения WAF недоступна. Сначала установите образ OpenResty с ModSecurity и CRS.',
            name: 'WAF',
        ...
        helper: {
            ...
            settingContent1: 'Установите пользовательское приветственное сообщение на странице входа в WorkMesh.',
            ...
            appContent1: 'Легко управляйте сервером WorkMesh в любое время и в любом месте.',
            ...
            vllmContent1:
                'Интегрируйте распределённые экземпляры vLLM в WorkMesh и централизованно отслеживайте версии, состояние работы и рабочие каталоги.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Поддерживаются только установочные пакеты `workmesh-agent_v*_*` или `workmesh-v*-linux-*`',
            ...
            panelExist:
                'Обнаружено, что на этом узле работает служба WorkMesh V1. Перед добавлением обновите до V2 с помощью скрипта миграции.',
            coreExist:
            ...
            agentExist:
                'Обнаружено, что workmesh-agent уже установлен на этом узле. Продолжение сохранит существующие данные и заменит только службу workmesh-agent.',
            agentNotExist:
                'Обнаружено, что на этом узле не установлен workmesh-agent, поэтому информацию об узле нельзя редактировать напрямую. Удалите его и добавьте снова.',
            oldDataExist:
                'Обнаружены исторические данные WorkMesh V2 на этом узле. Текущие настройки будут перезаписаны следующей информацией:',
            ...
            fixStatus: 'Запустите "systemctl status workmesh-agent.service", чтобы проверить, запущена ли служба.',
            ...
            uninstallHelper: 'Это удалит все данные WorkMesh, связанные с узлом. Выбирайте осторожно!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Функция: Настройка префикса образа и изменение поля образа в файле compose. Например, если префикс образа установлен как workmesh/custom, поле образа для MaxKB изменится на workmesh/custom/maxkb:v1.10.0',
