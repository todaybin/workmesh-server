...
const message = {
    commons: {
        ...
        login: {
            ...
            title: 'WorkMesh Server Management Panel',
    ...
    menu: {
        ...
        advanced: 'Advanced',
        waf: 'WAF',
        multiNode: 'Multi-node Management',
    ...
    home: {
        ...
        restart_workmesh: 'Restart panel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'This only saves the existing password to WorkMesh and does not change it in MySQL.',
        ...
        loadFromRemoteHelper: 'Sync databases, users, and authorizations from the server to WorkMesh. Continue?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'This model was not downloaded via WorkMesh, no related pull logs.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Select or enter a local tokenizer directory, e.g. /opt/workmesh/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Arguments are appended to the supergateway command. Transport, port, path, and protocol arguments managed by WorkMesh cannot be changed',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Detected that the container is from the App Store. Deleting the container will not completely remove it from WorkMesh. To delete it completely, go to the App Store -> 'Installed' or 'Runtime Environment' menus. Continue?",
        start: 'Start',
        stop: 'Stop',
        restart: 'Restart',
        kill: 'Kill',
        ...
        composeHelper:
            'The composition created through WorkMesh editor or template will be saved in the {0}/docker/compose directory.',
        ...
        running: 'Running ( {0} / {1} )',
        composeDetailHelper:
            'The compose is created external to WorkMesh. The start and stop operations are not supported.',
        ...
        composeEnvHelper2:
            'This orchestration was created by the WorkMesh App Store. Please modify environment variables in the installed applications.',
    ...
    cronjob: {
        ...
        logHelper1: '1. WorkMesh system log',
        ...
        cutWebsiteLogHelper: 'The rotated log files will be backed up to the backup directory of WorkMesh.',
    ...
    file: {
        ...
        clashDidNotSupport: 'File names are prohibited from containing .workmesh_clash',
        ...
        panelInstallDir: "WorkMesh installation directory can't be deleted",
    ...
    setting: {
        ...
        timeZoneHelper:
            'Timezone modification depends on the system timedatectl service. take effect after restart the WorkMesh service.',
        timeZoneCN: 'Bei Jing',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'WorkMesh domain binding configured',
        ...
        bindDomainHelper: 'After you bind the domain, only that domain can access WorkMesh service.',
        bindDomainHelper1: 'Leave it blank to disable the domain name binding.',
        bindDomainWarning:
            'After domain binding, you will be logged out and can only access WorkMesh service through the domain name specified in the settings. Continue?',
        ...
        mfaTitleHelper:
            'The title is used to distinguish different WorkMesh hosts. Scan again or manually add the secret key after you modify the title.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'This rule will be used to compress and backup the WorkMesh data directory during creating snapshot. By default, socket files are ignored.',
        ignoreHelper1: 'One per line. For example,\n*.log\n/opt/workmesh/cache',
        panelInfo: 'Write WorkMesh basic information',
        panelBin: 'Backup WorkMesh system files',
        daemonJson: 'Backup Docker configuration file',
        appData: 'Backup installed apps from WorkMesh',
        panelData: 'Backup WorkMesh data directory',
        backupData: 'Backup local backup directory for WorkMesh',
        ...
        recoverHelper1: 'Recovery requires restarting Docker and WorkMesh services',
        recoverHelper2:
        ...
        rollback: 'Rollback',
        rollbackHelper:
            'Rolling back this recovery will replace all files from this recovery, and may require restarting Docker and WorkMesh services. Continue?',
        upgradeRecord: 'Upgrade record',
        upgrading: 'Upgrading, please wait...',
        upgradeHelper: 'The upgrade requires restarting the WorkMesh service. Continue?',
        ...
        rollbackLocalHelper:
            'The primary node does not support direct rollback. Please manually execute the [wh restore] command to rollback!',
    ...
    license: {
        ...
        node: 'Upgrade to Commercial Edition to manage multiple Linux servers in WorkMesh.',
        ...
        vllm: 'Upgrade to Commercial Edition to manage vLLM services in WorkMesh with centralized deployment, configuration, lifecycle operations, and task tracking.',
        'model-downloader':
    ...
    clean: {
        scan: 'Start scanning',
        scanHelper: 'Easily clean up junk files produced during WorkMesh runtime',
        clean: 'Clean now',
        reScan: 'Rescan',
    ...
    app: {
        ...
        installIdInvalid: 'The application install ID is invalid. Refresh the installed applications and try again.',
    ...
    ssl: {
        ...
        shellHelper:
            'The default execution directory of the script is the WorkMesh installation directory. If a certificate is pushed into local directory, the execution directory will be the certificate push directory. The default execution timeout is 30 minutes.',
    ...
    firewall: {
        ...
        managedHelper: 'Created and managed by WorkMesh.',
        adopted: 'Externally managed',
        adoptedHelper: 'An existing system rule now managed by WorkMesh.',
        external: 'External rule',
        externalHelper: 'Not managed by WorkMesh.',
        ...
        adoptRuleConfirm: 'After takeover, WorkMesh can maintain and delete this existing rule. Continue?',
        ...
        plan_equivalent_managed_rule: 'An identical rule is already managed by WorkMesh. No duplicate is needed.',
        ...
        plan_managed_rule_drifted:
            'The WorkMesh management record differs from the live firewall rule. Check the system rule.',
        ...
        scopeUnmanagedActive: 'Other active scopes were detected: {0}. WorkMesh will not modify their rules.',
        ...
        dockerFirewallHelper: 'Selects how WorkMesh manages container port protection.',
        ...
        ruleSyncHelper:
            'Sync WorkMesh-managed rules from the selected firewall to the current firewall. Source rules stay unchanged, and external rules are not included.',
        ruleSyncDatabase: 'WorkMesh database',
        ruleSyncDatabaseHelper:
            'Synchronize and reconcile the managed rules in the current firewall based on the WorkMesh database rules. Missing rules will be added and extra rules will be removed.',
        ...
        resetDirectRulesHelper:
            'Delete all WorkMesh system firewall chains, runtime rules, and persisted files from {0}; saved database policies are retained',
        ...
        cleanupForwardingBackendHelper:
            'Reset the WorkMesh port forwarding runtime rules in {0}: delete all related rules and chains while retaining database data',
        cleanupDockerBackendHelper:
            'Reset the WorkMesh Docker port protection runtime rules in {0}: delete all related rules and chains while retaining database data',
        cleanupBeforeBackendSwitch:
            'The current {0} backend still contains WorkMesh runtime rules. Reset it before switching to {1}.',
        cleanupAction: 'Reset',
        backendSwitchNotice:
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'This will modify "files" value in "[include"] section in the main configuration file. The directory of other configuration file will be: "{WorkMesh installation directory}/workmesh/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Allows a small time difference between the identity provider and WorkMesh. Keep the default 60 seconds.',
                    ...
                    standardDiscoveryDesc:
                        'WorkMesh discovers endpoints and capabilities and does not store the raw document.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Reads this Attribute from the verified SAML Assertion and maps it to the WorkMesh username.',
                    ...
                    syncLogoutHelper:
                        'Signing out of either WorkMesh or the identity provider also signs out the other side.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Set the user search base and filter, then map the LDAP attribute used as the WorkMesh name.',
                    ...
                    attributeMapTooltip: 'JSON mapping from the WorkMesh name field to an LDAP attribute.',
                    attributeMapHelper: 'Set the LDAP attribute mapped to the WorkMesh name field.',
                    advanced: 'Advanced settings',
                    ...
                    sync: {
                        ...
                        description:
                            'Read the full LDAP directory on a schedule and maintain imported LDAP users in WorkMesh.',
                    ...
                    testLoginDesc:
                        'Bind with an AD/LDAP user credential to test authentication only. No WorkMesh session is created.',
        ...
        monitor: {
            ...
            monitorNotEnabled: 'Website monitoring is not enabled. Enable it now',
            monitorEnabled: 'Website monitoring is enabled',
        ...
        helper: {
            ...
            settingContent1: 'Set a custom welcome message on the WorkMesh login page.',
            ...
            appContent1: 'Easily manage your WorkMesh server anytime, anywhere.',
            ...
            vllmContent1:
                'Bring scattered vLLM services into WorkMesh for unified visibility of instances, versions, status, and runtime paths.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Only `workmesh-agent_v*_*` or `workmesh-v*-linux-*` installation packages are supported',
            ...
            panelExist:
                'Detected that this node is running WorkMesh V1 service. Please upgrade to V2 using the migration script before adding.',
            coreExist:
            ...
            agentExist:
                'Detected that workmesh-agent is already installed on this node. Continuing will retain existing data and only replace the workmesh-agent service.',
            agentNotExist:
                'It is detected that workmesh-agent is not installed on this node, so the node information cannot be edited directly. Please delete it and add it again.',
            oldDataExist:
                'Detected historical WorkMesh V2 data on this node. The following information will be used to overwrite current settings:',
            ...
            fixStatus: 'Run "systemctl status workmesh-agent.service" to check if the service is running.',
            ...
            uninstallHelper: 'This will delete all WorkMesh related data of the node. Proceed with caution!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Function: Customize the image prefix and modify the image field in the compose file. For example, when the image prefix is set to workmesh/custom, the image field for MaxKB will change to workmesh/custom/maxkb:v1.10.0',
