...
const message = {
    ...
    menu: {
        ...
        waf: 'WAF',
        multiNode: 'Gestión de múltiples nodos',
    ...
    home: {
        ...
        restart_workmesh: 'Reiniciar panel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Solo guarda la contraseña existente en WorkMesh; no cambia la contraseña en MySQL.',
        pgBindHelper:
        ...
        loadFromRemoteHelper:
            'Esto sincronizará las bases de datos, los usuarios y las autorizaciones del servidor con WorkMesh. ¿Desea continuar?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Este modelo no fue descargado vía WorkMesh, no hay registros de descarga relacionados.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Seleccione o introduzca un directorio local de tokenizador, p. ej. /opt/workmesh/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Los argumentos se añaden al comando supergateway. No se pueden cambiar los argumentos de transporte, puerto, ruta y protocolo gestionados por WorkMesh',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Se detectó que el contenedor proviene de la Tienda de Aplicaciones. Eliminar el contenedor no lo eliminará completamente de WorkMesh. Para eliminarlo por completo, vaya a la Tienda de Aplicaciones -> menús 'Instalado' o 'Entorno de Ejecución'. ¿Continuar?",
        start: 'Iniciar',
        stop: 'Detener',
        restart: 'Reiniciar',
        kill: 'Finalizar',
        ...
        composeHelper:
            'La composición creada mediante el editor o plantilla de WorkMesh se guardará en el directorio {0}/docker/compose.',
        ...
        composeDetailHelper:
            'La composición fue creada externamente a WorkMesh. Las operaciones de inicio y detención no son compatibles.',
        ...
        composeEnvHelper2:
            'Esta orquestación fue creada por la Tienda de Aplicaciones WorkMesh. Modifique las variables de entorno en las aplicaciones instaladas.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Los archivos de log rotados se respaldarán en el directorio de respaldos de WorkMesh.',
        ...
        logHelper1: '1. Registro del sistema de WorkMesh',
    ...
    file: {
        ...
        clashDidNotSupport: 'Los nombres de archivo no pueden contener .workmesh_clash',
        ...
        panelInstallDir: 'El directorio de instalación de WorkMesh no puede eliminarse',
    ...
    setting: {
        ...
        timeZoneHelper:
            'La modificación de zona horaria depende del servicio system timedatectl. Tomará efecto después de reiniciar el servicio WorkMesh.',
        timeZoneCN: 'Pekín',
        timeZoneAM: 'Los Ángeles',
        timeZoneNY: 'Nueva York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Vinculación de dominio de WorkMesh configurada',
        ...
        bindDomainHelper: 'Tras vincular el dominio, solo ese dominio podrá acceder al servicio de WorkMesh.',
        bindDomainHelper1: 'Déjalo en blanco para desactivar la vinculación de dominio.',
        bindDomainWarning:
            'Tras la vinculación del dominio, se cerrará la sesión y solo se podrá acceder al servicio WorkMesh mediante el dominio especificado. ¿Deseas continuar?',
        ...
        mfaTitleHelper:
            'El título se usa para distinguir diferentes hosts de WorkMesh. Tras modificarlo, vuelve a escanear o añade la clave secreta manualmente.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Esta regla se usará para comprimir y respaldar el directorio de datos de WorkMesh al crear la instantánea. Por defecto, se ignoran los archivos de socket.',
        ignoreHelper1: 'Una por línea. Por ejemplo,\n*.log\n/opt/workmesh/cache',
        panelInfo: 'Escribir información básica de WorkMesh',
        panelBin: 'Respaldar archivos del sistema WorkMesh',
        daemonJson: 'Respaldar archivo de configuración de Docker',
        appData: 'Respaldar aplicaciones instaladas de WorkMesh',
        panelData: 'Respaldar directorio de datos de WorkMesh',
        backupData: 'Respaldar directorio local de respaldo de WorkMesh',
        ...
        recoverHelper1: 'La recuperación requiere reiniciar Docker y los servicios de WorkMesh',
        recoverHelper2:
        ...
        rollback: 'Reversión',
        rollbackHelper:
            'Revertir esta recuperación reemplazará todos los archivos de esta recuperación y puede requerir reiniciar Docker y los servicios de WorkMesh. ¿Deseas continuar?',
        upgradeRecord: 'Registro de actualización',
        upgrading: ' Actualizando, por favor espera...',
        upgradeHelper: 'La actualización requiere reiniciar el servicio WorkMesh. ¿Deseas continuar?',
        ...
        rollbackLocalHelper:
            'El nodo principal no admite reversión directa. ¡Ejecuta manualmente el comando [wh restore] para revertir!',
    ...
    license: {
        ...
        node: 'Actualizar a la edición comercial permite administrar varios servidores Linux con WorkMesh.',
        nodeApp:
        ...
        vllm: 'Actualiza a la edición comercial para gestionar servicios vLLM en WorkMesh con despliegue, configuración, operaciones del ciclo de vida y seguimiento de tareas centralizados.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'Limpie fácilmente archivos basura generados por WorkMesh',
        clean: 'Limpiar ahora',
    ...
    ssl: {
        ...
        shellHelper:
            'Por defecto, el script se ejecuta en el directorio de instalación de WorkMesh. Si se guarda el certificado, será en ese directorio. Timeout: 30 minutos.',
    ...
    firewall: {
        ...
        managedHelper: 'Creada y mantenida por WorkMesh. Se puede editar o eliminar.',
        adopted: 'Externa gestionada',
        adoptedHelper: 'Una regla existente del sistema que ahora mantiene WorkMesh.',
        external: 'Regla externa',
        externalHelper:
            'Regla existente del sistema que aún no gestiona WorkMesh. Se puede adoptar cuando sea necesario.',
        ...
        adoptRuleConfirm: 'Después de asumirla, WorkMesh podrá mantener y eliminar esta regla existente. ¿Continuar?',
        ...
        plan_equivalent_managed_rule: 'WorkMesh ya gestiona una regla idéntica. No es necesario duplicarla.',
        ...
        scopeUnmanagedActive: 'Se detectaron otros ámbitos activos: {0}. WorkMesh no modificará sus reglas.',
        ...
        dockerFirewallHelper: 'Selecciona cómo gestiona WorkMesh la protección de puertos de contenedores.',
        ...
        resetDirectRulesHelper:
            'Elimina de {0} las cadenas, reglas activas y archivos persistentes del firewall de WorkMesh; se conservan las políticas de la base de datos',
        ...
        cleanupForwardingBackendHelper:
            'Restablece las reglas de ejecución del reenvío de puertos de WorkMesh en {0}: elimina todas las reglas y cadenas relacionadas y conserva los datos de la base de datos',
        cleanupDockerBackendHelper:
            'Restablece las reglas de ejecución de protección de puertos Docker de WorkMesh en {0}: elimina todas las reglas y cadenas relacionadas y conserva los datos de la base de datos',
        cleanupBeforeBackendSwitch:
            'El backend actual {0} todavía contiene reglas de ejecución de WorkMesh. Restablézcalo antes de cambiar a {1}.',
        ...
        ruleSyncHelper:
            'Sincroniza las reglas gestionadas por WorkMesh del firewall seleccionado al firewall actual. Las reglas de origen no se eliminan y las reglas externas no se incluyen.',
        ruleSyncDatabase: 'Base de datos de WorkMesh',
        ruleSyncDatabaseHelper:
            'Sincroniza y concilia las reglas administradas del firewall actual con las reglas de la base de datos de WorkMesh. Se añadirán las reglas que falten y se eliminarán las sobrantes.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Esto modificará el valor de "files" en la sección "[include]" del archivo de configuración principal. El directorio de otros archivos de configuración será: "{directorio de instalación de WorkMesh}/workmesh/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Permite una pequeña diferencia horaria entre el proveedor de identidad y WorkMesh. Mantenga el valor predeterminado de 60 segundos.',
                    ...
                    panelURL: 'URL pública de WorkMesh',
                    panelURLHTTPWarning:
                        'HTTP no protege la respuesta de autorización. Úselo solo en un entorno privado aislado aceptado por el proveedor.',
                    panelURLHelper:
                        'Introduzca la dirección que usan los usuarios para acceder a WorkMesh. Se utiliza para generar la URL de retorno.',
                    panelURLInvalid: 'Ingrese un origen que contenga solo esquema, host y puerto opcional.',
                    panelURLRequired: 'Introduzca la URL pública de WorkMesh.',
                    ...
                    standardDiscoveryDesc:
                        'WorkMesh descubre los endpoints y las capacidades, pero no almacena el documento sin procesar.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Lee este atributo de la aserción SAML verificada y lo asigna al nombre de usuario de WorkMesh.',
                    ...
                    syncLogoutHelper:
                        'Cerrar sesión en WorkMesh o en el proveedor de identidad también cierra la sesión del otro lado.',
                    testBeforeBrowserTest:
                        'Pruebe la configuración actual antes de iniciar la prueba de inicio de sesión en el navegador.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Configure la base y el filtro de búsqueda, y asigne el atributo LDAP al campo name de WorkMesh.',
                    ...
                    attributeMapTooltip: 'Mapeo JSON del campo name de WorkMesh a un atributo LDAP.',
                    attributeMapHelper: 'Configure el atributo LDAP asignado al campo name de WorkMesh.',
                    ...
                    sync: {
                        ...
                        description:
                            'Lea el directorio LDAP completo de forma programada y mantenga los usuarios LDAP importados en WorkMesh.',
                    ...
                    testLoginDesc:
                        'Vincule con una credencial de usuario AD/LDAP para probar solo la autenticación. No se crea ninguna sesión WorkMesh.',
        ...
        waf: {
           WAF: 'WAF',
            time: 'Hora',
            runtimeUnavailable: 'El entorno de ejecución de WAF no está disponible. Instale primero una imagen OpenResty con ModSecurity y CRS.',
            name: 'WAF',
        ...
        helper: {
            ...
            settingContent1: 'Configura un mensaje de bienvenida en la página de login de WorkMesh.',
            ...
            appContent1: 'Gestiona tu servidor WorkMesh en cualquier momento y lugar.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Solo se admiten paquetes de instalación `workmesh-agent_v*_*` o `workmesh-v*-linux-*`',
            ...
            panelExist:
                'Se ha detectado que este nodo ejecuta WorkMesh V1. Actualiza a V2 usando el script de migración antes de añadirlo.',
            coreExist:
            ...
            agentExist:
                'Se ha detectado que workmesh-agent ya está instalado en este nodo. Continuar conservará los datos y solo reemplazará el servicio de workmesh-agent.',
            agentNotExist:
                'Se ha detectado que workmesh-agent no está instalado en este nodo, por lo que la información no puede editarse directamente. Elimínalo y vuelve a añadirlo.',
            oldDataExist:
                'Se han detectado datos históricos de WorkMesh V2 en este nodo. La siguiente información sobrescribirá la configuración actual:',
            ...
            fixStatus:
                'Ejecuta "systemctl status workmesh-agent.service" para verificar si el servicio está en ejecución.',
            ...
            uninstallHelper:
                'Esto eliminará todos los datos relacionados con WorkMesh de este nodo. Procede con precaución.',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Función: Personaliza el prefijo de la imagen y modifica el campo image en el archivo compose. Ejemplo: si el prefijo es workmesh/custom, la imagen de MaxKB pasará a ser workmesh/custom/maxkb:v1.10.0',
