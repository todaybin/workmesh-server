...
const message = {
    ...
    database: {
        ...
        supplementPasswordHelper: '仅将现有密码保存到 WorkMesh，不会修改 MySQL 用户密码。',
        noUserBind: '不绑定',
        pgBindHelper: '该操作用于创建新用户并将其绑定到目标数据库，暂不支持选择已存在于数据库中的用户。',
        pgSuperUser: '超级用户',
        loadFromRemoteHelper: '此操作将同步服务器上的数据库、用户及授权信息到 WorkMesh，是否继续？',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: '该模型并非通过 WorkMesh 下载，无相关拉取日志。',
            ...
            ascendVisibleDevices: 'Ascend 可见设备（ASCEND_RT_VISIBLE_DEVICES）',
        ...
        skillsHub: {
            ...
            publish: '上架',
            disable: '下架',
            customTarget: '智能体 Skill 目录',
            installToTarget: '安装到智能体 Skill 目录',
            ...
            deleteTargetConfirm: '确认删除该智能体 Skill 目录配置？删除后用户不能继续选择该安装目录。',
            noInstallTarget: '暂无可用的智能体 Skill 目录，请先添加。',
        ...
        benchmark: {
            ...
            endpoint: '接口路径',
            tokenizer: '分词器',
            tokenizerPlaceholder: '请选择或输入本地分词器目录，例如 /opt/workmesh/tokenizers/DeepSeek-V3',
            runConfig: '运行配置',
            rawResult: '原始结果',
            resultMetrics: '结果指标',
            contextTokens: '上下文长度',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                '参数将追加到 supergateway 启动命令，不支持修改由 WorkMesh 管理的传输、端口、路径和协议参数',
            testConnection: '测试连接',
    ...
    container: {
        ...
        containerDeleteHelper:
            '检测到容器来源于应用商店，删除容器不会将其从 WorkMesh 中完全移除。如需彻底删除，请前往应用商店-『已安装』或『运行环境』等菜单中操作。是否继续？',
        start: '启动',
        stop: '停止',
        restart: '重启',
        kill: '强制停止',
        ...
        network: '网络',
        networkHelper: '删除 workmesh-network 容器网络将影响部分应用和运行环境的正常使用，是否继续？',
        networkName: '网络名',
        driver: '模式',
        option: '参数',
        attachable: '可用',
        ...
        composeHelper: '通过 WorkMesh 编辑或模版创建的编排，将保存在 {0}/docker/compose 路径下',
        deleteFile: '删除文件',
        ...
        exited: '已停止',
        running: '运行中 ( {0} / {1} )',
        composeDetailHelper: '该 compose 为 WorkMesh 编排外部创建。暂不支持启停操作。',
        composeOperatorHelper: '将对 {0} 进行 {1} 操作，是否继续？',
        composeDownHelper: '将停止并删除 {0} 编排下所有容器及网络，是否继续？',
        composeEnvHelper2: '该编排为 WorkMesh 应用商店创建，请在已安装应用中修改环境变量。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日志文件会备份到 WorkMesh 的 backup 目录下',
    ...
    file: {
        ...
        clashDidNotSupport: '文件名禁止包含 .workmesh_clash',
        ...
        previewLargeFile: '预览',
        panelInstallDir: 'WorkMesh 安装目录不能删除',
        wgetTask: '下载任务',
    ...
    setting: {
        ...
        timeZoneHelper: '时区修改依赖系统 timedatectl 服务，重启 WorkMesh 服务后生效。',
        timeZoneCN: '北京',
        timeZoneAM: '洛杉矶',
        timeZoneNY: '纽约',
        ntpALi: '阿里云',
        ...
        developerModeHelper: '获取 WorkMesh 的预览版本，以分享有关新功能和更新的反馈',
        ...
        ignoreHelper: '快照时将使用该规则对 WorkMesh 数据目录进行压缩备份，请谨慎修改。',
        ignoreHelper1: '一行一个，例： \n*.log\n/opt/workmesh/cache',
        status: '快照状态',
        panelInfo: '写入 WorkMesh 基础信息',
        panelBin: '备份 WorkMesh 系统文件',
        daemonJson: '备份 Docker 配置文件',
        appData: '备份 WorkMesh 已安装应用',
        panelData: '备份 WorkMesh 数据目录',
        backupData: '备份 WorkMesh 本地备份目录',
        compress: '制作快照文件',
        upload: '上传快照文件',
        recoverDetail: '恢复详情',
        ...
        recoverHelper1: '恢复需要重启 Docker 以及 WorkMesh 服务',
        ...
        rollback: '回滚',
        rollbackHelper:
            '即将回滚本次恢复，回滚将替换所有本次恢复的文件，过程中可能需要重启 Docker 以及 WorkMesh 服务，是否继续？',

        upgradeRecord: '更新记录',
        upgrading: '正在升级中，请稍候...',
        upgradeHelper: '升级操作需要重启 WorkMesh 服务，是否继续？',
        noUpgrade: '当前已经是最新版本',
        versionHelper: 'WorkMesh 版本号命名规则为： [大版本].[功能版本].[Bug 修复版本]，例：',
        rollbackLocalHelper: '主节点暂不支持直接回滚，请手动执行 wh restore 命令回滚！',
        upgradeCheck: '检查更新',
        upgradeNotes: '更新内容',
        upgradeNow: '立即更新',
        source: '下载源',
        ...
        bindDomainHelper: '设置域名绑定后，仅能通过设置中域名访问 WorkMesh 服务',
        bindDomainHelper1: '绑定域名为空时，则取消域名绑定',
        bindDomainWarning: '设置域名绑定后，将退出当前登录，且仅能通过设置中域名访问 WorkMesh 服务，是否继续？',
        allowIPs: '授权 IP',
        unAllowIPs: '取消授权',
        unAllowIPsWarning: '授权 IP 为空将允许所有 IP 访问系统，可能造成系统不安全，是否继续？',
        allowIPsHelper: '设置授权 IP 后，仅有设置中的 IP 可以访问 WorkMesh 服务',
        allowIPsWarning: '设置授权 IP 后，仅有设置中的 IP 可以访问 WorkMesh 服务，是否继续？',
        ...
        mfaCode: '验证码',
        mfaInterval: '刷新时间（秒）',
        mfaTitleHelper: '用于区分不同 WorkMesh 主机，修改后请重新扫描或手动添加密钥信息！',
        mfaIntervalHelper:
        ...
        passkeyPrereqBindDomain: '已设置 WorkMesh 域名绑定',
    ...
    license: {
        ...
        node: '升级商业版可以使用 WorkMesh 管理多台 linux 服务器。',
        ...
        vllm: '升级商业版可将 vLLM 服务统一纳入 WorkMesh 管理，集中完成部署、配置调整、状态运维与任务追踪，降低本地模型服务维护成本。',
        'model-downloader':
            '升级商业版可从 HuggingFace、ModelScope 或兼容镜像站搜索、下载并管理本地模型文件，统一维护本地模型目录与下载任务。',
    },
    clean: {
        scan: '开始扫描',
        scanHelper: '轻松梳理 WorkMesh 运行期间积累的垃圾文件',
        clean: '立即清理',
        reScan: '重新扫描',
    ...
    app: {
        ...
        backupdate: '备份时间',
        versionSelect: '请选择版本',
        installIdInvalid: '应用安装标识无效，请刷新已安装应用列表后重试',
    ...
    ssl: {
        ...
        shell: '脚本内容',
        shellHelper:
            '脚本默认执行目录为 WorkMesh 安装目录，如果有推送证书，那么执行目录为证书推送目录。默认超时时间 30 分钟',
    ...
    firewall: {
        ...
        unUsed: '未使用',
        managed: '面板创建',
        managedHelper: '由 WorkMesh 创建并管理。',
        adopted: '外部纳管',
        adoptedHelper: '系统原有规则，现由 WorkMesh 管理。',
        external: '外部规则',
        externalHelper: '尚未纳入 WorkMesh 管理。',
        protected: '系统保护',
        ...
        resolution_adopt: '纳管',
        adoptRuleConfirm: '纳入管理后，WorkMesh 将负责维护和删除这条现有规则，是否继续？',
        ...
        plan_equivalent_managed_rule: '相同规则已由 WorkMesh 管理，无需重复创建。',
        ...
        plan_managed_rule_drifted: 'WorkMesh 管理记录与系统实际规则不一致，请检查系统规则。',
        plan_opaque_rule_in_target_scope: '目标范围内存在无法安全解析的规则，本次操作已停止。',
        plan_runtime_permanent_mismatch: '防火墙运行配置与永久配置不一致，请先完成同步。',
        plan_protected_rule: '该规则受到保护，不能认领、修改或删除。',
        plan_blocked: '当前规则无法安全应用，请刷新规则后重试。',
        ...
        scopeUnmanagedActive: '检测到其他活动范围：{0}，WorkMesh 不会修改其中的规则。',
        ...
        dockerFirewallHelper: '用于选择 WorkMesh 容器端口防护的管理方式。',
        dockerNftablesRequirement: 'Docker ≥ 29.0.0，实验性',
        backendRecommendation: '建议使用 iptables 或 nftables 管理。',
        configuredRules: '已配置 {0} 条规则',
        addressFamily: 'IP 版本',
        portOrRange: '端口 / 范围',
        exportAllRules: '导出全部规则',
        importBackendHelper: '导入规则会转换并写入当前后端 {0}，源后端规则不会被修改。',
        ruleSyncTitle: '同步规则',
        ruleSyncAction: '同步规则',
        ruleSyncHelper: '将所选防火墙中由 WorkMesh 管理的规则同步到当前防火墙。原规则不会删除，外部规则不会同步。',
        ruleSyncDatabase: 'WorkMesh 数据库',
        ruleSyncDatabaseHelper:
            '以 WorkMesh 数据库规则为准，同步并校准当前防火墙中的管理规则。缺失规则会被添加，多余规则会被删除。',
        ...
        ruleSyncReasonDetail: {
            matchesDatabasePolicy: '该规则已与数据库策略一致。',
            managedOrderDiffers: '受管规则顺序与数据库顺序不一致。',
            managedOnlyInTarget: '该受管规则仅存在于目标防火墙中。',
            managedRuntimeCannotRemove: '无法安全删除该受管运行时规则。',
            managedOrderBlocked: '受管规则的排序不能跨越外部、无法识别或受保护的规则。',
            mayBlockManagement: '该规则可能会阻断当前管理连接。',
            missingFromTarget: '目标防火墙中缺少该规则。',
            targetDiffers: '目标规则与数据库策略不一致。',
            alreadyExistsInTarget: '目标防火墙中已存在该规则。',
            onlyInTarget: '该规则仅存在于目标防火墙中。',
            stale: '防火墙规则状态已过期，请刷新后重试。',
            lockoutRisk: '此次防火墙变更可能会阻断管理访问。',
            protectedRule: '该防火墙规则受保护，无法修改。',
            cannotReconcile: '无法同步目标规则：{0}',
        },
        ruleSyncConfirm: '即将把 {0} 条规则从 {1} 同步到 {2}，源后端不会被修改。是否继续？',
        ruleSyncResetSource: '同步成功后重置并停用源防火墙 {0}',
        ruleSyncResetSourceHelper: '仅在全部规则同步成功后重置源防火墙，此操作不可恢复。',
        ruleSyncResetSourceBlocked: '存在不可同步规则，请先处理后再自动重置源防火墙。',
        ruleSyncResetSourceConfirm:
            '即将把 {0} 条规则从 {1} 同步到 {2}，成功后重置并停用 {1}。这会删除 {1} 的全部防火墙配置且不可恢复，是否继续？',
        ...
        resetDirectRulesHelper: '删除 {0} 中全部 WorkMesh 系统防火墙链、运行规则及持久化文件，保留数据库策略',
        resetWhitelistRulesHelper:
            '重置 {0} 中当前生效的自定义防火墙配置，恢复安装默认状态并停用 {0}；数据库策略会保留，之后可以重新同步。',
        cleanupForwardingBackendHelper:
            '重置 {0} 中的 WorkMesh 端口转发运行时规则：删除全部相关规则及规则链，仅保留数据库数据',
        cleanupDockerBackendHelper:
            '重置 {0} 中的 WorkMesh Docker 端口防护运行时规则：删除全部相关规则及规则链，仅保留数据库数据',
        cleanupBeforeBackendSwitch: '当前后端 {0} 仍存在 WorkMesh 运行时规则，请先重置该后端，再切换到 {1}。',
        cleanupAction: '重置',
        backendSwitchNotice:
    ...
    tool: {
        supervisor: {
            ...
            numprocs: '进程数量',
            initWarn:
                '初始化操作需要修改配置文件的 [include] files 参数，修改后的服务配置文件所在目录: workmesh安装目录/workmesh/tools/supervisord/supervisor.d/',
            operatorHelper: '将对 {0} 进行 {1} 操作，是否继续？',
            uptime: '运行时长',
    ...
    xpack: {
        ...
        monitor: {
            ...
            qps: '实时请求数（1分钟）',
            flowSec: '实时流量（1分钟）',
            monitorNotEnabled: '当前网站监控未开启，立即开启',
            monitorEnabled: '当前网站监控已开启',
            enableNow: '立即开启',
            source: '来源',
            quantity: '数量',
            excludeCode: '排除状态码',
        ...
        helper: {
            ...
            settingContent1: '在 WorkMesh 登录页上设置自定义的欢迎语。',
            ...
            appTitle1: '灵活管理面板',
            appContent1: '随时随地轻松管理你的 WorkMesh 服务器。',
            appTitle2: '全面服务信息',
            ...
            vllmTitle1: '统一纳管',
            vllmContent1: '将分散的 vLLM 服务统一接入 WorkMesh，集中查看实例、版本、状态与运行目录。',
            vllmTitle2: '快速部署',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper: '仅支持 `workmesh-agent_v*_*` 或 `workmesh-v*-linux-*` 安装包',
            ...
            checkPort: '检查节点端口可达',
            panelExist: '检查到该节点正在运行 WorkMesh V1 服务，请先通过迁移脚本升级至 V2 后再进行添加。',
            coreExist:
                '当前节点已作为主节点启用，无法直接作为从节点添加。请先将其降级为从节点后再添加，具体可参考文档。',
            agentExist: '检查到该节点已安装 workmesh-agent，继续添加将保留现有数据，仅替换 workmesh-agent 服务。',
            agentNotExist: '检查到该节点未安装 workmesh-agent，无法直接编辑该节点信息，请先删除后重新添加。',
            oldDataExist: '检查到该节点存在 WorkMesh V2 历史数据，将使用以下信息覆盖当前设置',
            ...
            fixStatus: 'systemctl status workmesh-agent.service 检查服务是否已启动',
            ...
            uninstall: '删除节点数据',
            uninstallHelper: '将删除节点所有 WorkMesh 相关数据，谨慎选择！',
        ...
        customApp: {
            ...
            imagePrefix: '镜像前缀',
            imagePrefixHelper:
                '用于自定义镜像前缀，自动修改 Compose 文件中的镜像字段。\n 例如，当镜像前缀设置为 workmesh/custom 时，MaxKB 的镜像将变更为 workmesh/custom/maxkb:v1.10.0。',
