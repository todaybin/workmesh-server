...
const message = {
    ...
    menu: {
        ...
        advanced: 'Ciri Lanjutan',
        waf: 'WAF',
        multiNode: 'Pengurusan Berbilang Nod',
    ...
    home: {
        ...
        restart_workmesh: 'Mulakan semula panel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Hanya menyimpan kata laluan sedia ada ke WorkMesh dan tidak mengubahnya dalam MySQL.',
        ...
        loadFromRemoteHelper:
            'Ini akan menyelaraskan pangkalan data, pengguna dan kebenaran dari pelayan ke WorkMesh. Teruskan?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Model ini tidak dimuat turun melalui WorkMesh; tiada log muat turun berkaitan.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Pilih atau masukkan direktori tokenizer tempatan, cth. /opt/workmesh/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Argumen ditambahkan pada arahan supergateway. Argumen pengangkutan, port, laluan dan protokol yang diurus oleh WorkMesh tidak boleh diubah',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Dikesan bahawa bekas ini berasal dari Kedai Apl. Memadam bekas tidak akan mengalihnya sepenuhnya dari WorkMesh. Untuk memadam sepenuhnya, sila pergi ke Kedai Apl -> menu 'Dipasang' atau 'Persekitaran Runtime'. Teruskan?",
        start: 'Mulakan',
        stop: 'Hentikan',
        restart: 'Mulakan semula',
        kill: 'Hentikan paksa',
        ...
        composeHelper:
            'Komposisi yang dicipta melalui editor atau templat WorkMesh akan disimpan dalam direktori {0}/docker/compose.',
        ...
        composeDetailHelper: 'Komposisi dibuat di luar WorkMesh. Operasi mula dan berhenti tidak disokong.',
        ...
        composeEnvHelper2:
            'Penyelarasan ini dibuat oleh Kedai Apl WorkMesh. Sila ubah pembolehubah persekitaran dalam aplikasi yang dipasang.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Fail log yang diputar akan disandarkan ke direktori sandaran WorkMesh.',
        ...
        logHelper1: '1. Log sistem WorkMesh',
    ...
    file: {
        ...
        clashDidNotSupport: 'Nama fail dilarang mengandungi .workmesh_clash',
        ...
        panelInstallDir: 'Direktori pemasangan WorkMesh tidak boleh dipadamkan',
    ...
    setting: {
        ...
        timeZoneHelper:
            'Pengubahan zon waktu bergantung pada perkhidmatan sistem timedatectl. Berkuat kuasa selepas mulakan semula perkhidmatan WorkMesh.',
        timeZoneCN: 'Beijing',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'New York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Pengikatan domain WorkMesh dikonfigurasi',
        ...
        bindDomainHelper: 'Selepas anda mengikat domain, hanya domain itu yang boleh mengakses perkhidmatan WorkMesh.',
        bindDomainHelper1: 'Biarkan kosong untuk melumpuhkan ikatan nama domain.',
        bindDomainWarning:
            'Selepas ikatan domain, anda akan log keluar dan hanya boleh mengakses perkhidmatan WorkMesh melalui nama domain yang ditentukan dalam tetapan. Adakah anda mahu meneruskan?',
        ...
        mfaTitleHelper:
            'Judul digunakan untuk membezakan hos WorkMesh yang berbeza. Imbas lagi atau tambahkan kunci rahsia secara manual selepas anda mengubah judul.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Aturan ini akan digunakan untuk memampatkan dan menyandarkan direktori data WorkMesh semasa membuat snapshot. Secara lalai, fail soket diabaikan.',
        ignoreHelper1: 'Satu per baris. Contoh,\n*.log\n/opt/workmesh/cache',
        panelInfo: 'Tulis maklumat asas WorkMesh',
        panelBin: 'Sandarkan fail sistem WorkMesh',
        daemonJson: 'Sandarkan fail konfigurasi Docker',
        appData: 'Sandarkan aplikasi yang dipasang dari WorkMesh',
        panelData: 'Sandarkan direktori data WorkMesh',
        backupData: 'Sandarkan direktori sandaran tempatan untuk WorkMesh',
        ...
        recoverHelper1: 'Pemulihan memerlukan mulakan semula perkhidmatan Docker dan WorkMesh',
        recoverHelper2:
        ...
        rollbackHelper:
            'Pulangkan semula pemulihan ini akan menggantikan semua fail dari pemulihan ini, dan mungkin memerlukan mulakan semula perkhidmatan Docker dan WorkMesh. Adakah anda mahu meneruskan?',
        upgradeHelper: 'Kemas kini memerlukan mulakan semula perkhidmatan WorkMesh. Adakah anda mahu meneruskan?',
        rollbackLocalHelper:
            'Nod utama tidak menyokong rollback secara langsung. Sila laksanakan arahan [wh restore] secara manual untuk rollback!',
    ...
    license: {
        ...
        node: 'Naik taraf ke Edisi Komersial untuk mengurus berbilang pelayan Linux dengan WorkMesh.',
        nodeApp:
        ...
        vllm: 'Naik taraf ke Edisi Komersial untuk mengurus perkhidmatan vLLM secara berpusat dalam WorkMesh, termasuk penggunaan, konfigurasi, operasi kitar hayat dan penjejakan tugas.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'Bersihkan fail sampah dengan mudah yang dihasilkan semasa operasi WorkMesh',
    ...
    ssl: {
        ...
        shellHelper:
            'Direktori pelaksanaan lalai skrip adalah direktori pemasangan WorkMesh. Jika sijil ditolak ke direktori tempatan, direktori pelaksanaan akan menjadi direktori tolak sijil. Tamat masa pelaksanaan lalai ialah 30 minit.',
    ...
    firewall: {
        ...
        managedHelper: 'Dicipta dan diselenggara oleh WorkMesh. Peraturan ini boleh diedit atau dipadam.',
        adopted: 'Luaran terurus',
        adoptedHelper: 'Peraturan sistem sedia ada yang kini diselenggara oleh WorkMesh.',
        external: 'Peraturan luaran',
        externalHelper:
            'Peraturan sistem sedia ada yang belum diurus oleh WorkMesh. Ia boleh diambil alih apabila diperlukan.',
        ...
        adoptRuleConfirm:
            'Selepas diambil alih, WorkMesh boleh menyelenggara dan memadam peraturan sedia ada ini. Teruskan?',
        ...
        plan_equivalent_managed_rule: 'Peraturan yang sama sudah diurus oleh WorkMesh. Pendua tidak diperlukan.',
        ...
        scopeUnmanagedActive: 'Skop aktif lain dikesan: {0}. WorkMesh tidak akan mengubah peraturannya.',
        ...
        dockerFirewallHelper: 'Memilih cara WorkMesh mengurus perlindungan port bekas.',
        ...
        resetDirectRulesHelper:
            'Padam rantaian, peraturan masa jalan dan fail berterusan tembok api sistem WorkMesh daripada {0}; dasar pangkalan data yang disimpan dikekalkan',
        ...
        cleanupForwardingBackendHelper:
            'Tetapkan semula peraturan masa jalan pemajuan port WorkMesh dalam {0}: padam semua peraturan dan rantaian berkaitan sambil mengekalkan data pangkalan data',
        cleanupDockerBackendHelper:
            'Tetapkan semula peraturan masa jalan perlindungan port Docker WorkMesh dalam {0}: padam semua peraturan dan rantaian berkaitan sambil mengekalkan data pangkalan data',
        cleanupBeforeBackendSwitch:
            'Bahagian belakang semasa {0} masih mengandungi peraturan masa jalan WorkMesh. Tetapkan semula sebelum bertukar kepada {1}.',
        ...
        ruleSyncHelper:
            'Segerakkan peraturan yang diurus oleh WorkMesh daripada tembok api terpilih ke tembok api semasa. Peraturan sumber tidak dipadam dan peraturan luaran tidak disertakan.',
        ruleSyncDatabase: 'Pangkalan data WorkMesh',
        ruleSyncDatabaseHelper:
            'Segerakkan dan selaraskan peraturan terurus dalam tembok api semasa berdasarkan peraturan pangkalan data WorkMesh. Peraturan yang tiada akan ditambah dan peraturan berlebihan akan dipadam.',
    ...
    tool: {
        supervisor: {
            ...
            numprocs: 'Bil. proses',
            initWarn:
                'Ini akan mengubah nilai "files" dalam bahagian "[include]" dalam fail konfigurasi utama. Direktori fail konfigurasi lain akan menjadi: "{direktori pemasangan WorkMesh}/workmesh/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Membenarkan sedikit perbezaan masa antara penyedia identiti dan WorkMesh. Kekalkan nilai lalai 60 saat.',
                    ...
                    panelURLHelper:
                        'Masukkan alamat yang digunakan untuk mengakses WorkMesh. Alamat ini digunakan untuk menjana URL panggil balik.',
                    panelURLInvalid: 'Masukkan asal yang mengandungi hanya skema, hos dan port pilihan.',
                    panelURLRequired: 'Masukkan WorkMesh awam URL.',
                    ...
                    standardDiscoveryDesc:
                        'WorkMesh menemui titik akhir dan keupayaan dan tidak menyimpan dokumen mentah.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Membaca atribut ini daripada SAML Assertion yang disahkan dan memetakannya kepada nama pengguna WorkMesh.',
                    ...
                    syncLogoutHelper:
                        'Log keluar daripada WorkMesh atau penyedia identiti turut melog keluar bahagian yang lain.',
                    testBeforeBrowserTest: 'Uji konfigurasi semasa sebelum memulakan ujian log masuk penyemak imbas.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Tetapkan pangkalan carian dan penapis pengguna, kemudian petakan atribut LDAP yang digunakan sebagai WorkMesh name.',
                    ...
                    attributeMapTooltip: 'Pemetaan JSON daripada medan WorkMesh name kepada atribut LDAP.',
                    attributeMapHelper: 'Tetapkan atribut LDAP yang dipetakan ke medan WorkMesh name.',
                    advanced: 'Tetapan lanjutan',
                    ...
                    sync: {
                        ...
                        description:
                            'Baca direktori LDAP penuh mengikut jadual dan kekalkan pengguna LDAP yang diimport dalam WorkMesh.',
                    ...
                    testLoginDesc:
                        'Ikat dengan bukti kelayakan pengguna AD/LDAP untuk menguji pengesahan sahaja. Tiada sesi WorkMesh dibuat.',
        ...
        waf: {
           WAF: 'WAF',
            time: 'Masa',
            runtimeUnavailable: 'Runtime WAF tidak tersedia. Pasang imej OpenResty dengan ModSecurity dan CRS terlebih dahulu.',
            name: 'WAF',
        ...
        helper: {
            ...
            settingContent1: 'Tetapkan mesej selamat datang tersuai pada halaman log masuk WorkMesh.',
            ...
            appContent1: 'Uruskan pelayan WorkMesh anda dengan mudah pada bila-bila masa dan di mana sahaja.',
            ...
            vllmContent1:
                'Integrasikan instans vLLM yang diedarkan ke dalam WorkMesh dan pantau versi, status operasi serta direktori kerja secara berpusat.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Hanya pakej pemasangan `workmesh-agent_v*_*` atau `workmesh-v*-linux-*` disokong',
            ...
            panelExist:
                'Mengesan nod ini sedang menjalankan perkhidmatan WorkMesh V1. Sila naik taraf ke V2 menggunakan skrip migrasi sebelum menambah.',
            coreExist:
            ...
            agentExist:
                'Mengesan workmesh-agent telah dipasang pada nod ini. Penerusan akan mengekalkan data sedia ada dan hanya menggantikan perkhidmatan workmesh-agent.',
            agentNotExist:
                'Terdapat pengesahan bahawa workmesh-agent tidak dipasang pada nod ini, maklumat nod tidak boleh disunting secara langsung. Sila padam dan tambah semula.',
            oldDataExist:
                'Mengesan data sejarah WorkMesh V2 pada nod ini. Maklumat berikut akan digunakan untuk menimpa tetapan semasa:',
            ...
            fixStatus:
                'Jalankan "systemctl status workmesh-agent.service" untuk memeriksa sama ada perkhidmatan sedang berjalan.',
            ...
            uninstallHelper: 'Ini akan memadamkan semua data berkaitan WorkMesh bagi nod. Pilih dengan berhati-hati!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Fungsi: Sesuaikan awalan imej dan ubah medan imej dalam fail compose. Contohnya, apabila awalan imej ditetapkan kepada workmesh/custom, medan imej untuk MaxKB akan bertukar kepada workmesh/custom/maxkb:v1.10.0',
