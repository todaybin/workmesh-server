...
const message = {
    ...
    menu: {
        ...
        waf: 'WAF',
        multiNode: 'Gerenciamento de múltiplos nós',
    ...
    home: {
        ...
        restart_workmesh: 'Reiniciar painel',
    ...
    database: {
        ...
        supplementPasswordHelper: 'Apenas salva a senha existente no WorkMesh; não altera a senha no MySQL.',
        ...
        loadFromRemoteHelper:
            'Isso sincronizará bancos de dados, usuários e autorizações do servidor com o WorkMesh. Deseja continuar?',
    ...
    aiTools: {
        ...
        model: {
            ...
            from_remote: 'Este modelo não foi baixado pelo WorkMesh; não há logs de download relacionados.',
        ...
        benchmark: {
            ...
            tokenizerPlaceholder:
                'Selecione ou informe um diretório local de tokenizer, ex.: /opt/workmesh/tokenizers/DeepSeek-V3',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Os argumentos são adicionados ao comando supergateway. Os parâmetros de transporte, porta, caminho e protocolo gerenciados pelo WorkMesh não podem ser alterados',
    ...
    container: {
        ...
        containerDeleteHelper:
            "Detectado que o contêiner é da App Store. Excluir o contêiner não o removerá completamente do WorkMesh. Para excluí-lo completamente, vá para a App Store -> menus 'Instalado' ou 'Ambiente de Execução'. Continuar?",
        start: 'Iniciar',
        stop: 'Parar',
        restart: 'Reiniciar',
        kill: 'Finalizar',
        ...
        composeHelper:
            'A composição criada através do editor ou template do WorkMesh será salva no diretório {0}/docker/compose.',
        ...
        composeDetailHelper:
            'A composição foi criada externamente ao WorkMesh. As operações de iniciar e parar não são suportadas.',
        ...
        composeEnvHelper2:
            'Esta orquestração foi criada pela Loja de Aplicativos WorkMesh. Modifique as variáveis de ambiente nos aplicativos instalados.',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: 'Os arquivos de log rotacionados serão salvos no diretório de backup do WorkMesh.',
        ...
        logHelper1: '1. Log do sistema WorkMesh',
        cronSpecDoc:
    ...
    file: {
        ...
        clashDidNotSupport: 'Os nomes de arquivos são proibidos de conter .workmesh_clash',
        ...
        panelInstallDir: 'O diretório de instalação do WorkMesh não pode ser excluído',
    ...
    setting: {
        ...
        timeZoneHelper:
            'A modificação de fuso horário depende do serviço timedatectl do sistema. Entrará em vigor após reiniciar o serviço WorkMesh.',
        timeZoneCN: 'Pequim',
        timeZoneAM: 'Los Angeles',
        timeZoneNY: 'Nova York',
        ntpALi: 'Alibaba',
        ...
        passkeyPrereqBindDomain: 'Vinculação de domínio do WorkMesh configurada',
        ...
        bindDomainHelper: 'Após vincular o domínio, somente esse domínio poderá acessar o serviço WorkMesh.',
        bindDomainHelper1: 'Deixe em branco para desabilitar o vínculo de domínio.',
        bindDomainWarning:
            'Após vincular o domínio, você será desconectado e poderá acessar o serviço WorkMesh apenas através do domínio especificado nas configurações. Você deseja continuar?',
        ...
        mfaTitleHelper:
            'O título é usado para distinguir diferentes hosts do WorkMesh. Escaneie novamente ou adicione manualmente a chave secreta após modificar o título.',
        mfaIntervalHelper:
        ...
        ignoreHelper:
            'Esta regra será usada para comprimir e fazer backup do diretório de dados do WorkMesh durante a criação do snapshot. Por padrão, arquivos de socket são ignorados.',
        ignoreHelper1: 'Um por linha. Exemplo,\n*.log\n/opt/workmesh/cache',
        panelInfo: 'Escrever informações básicas do WorkMesh',
        panelBin: 'Fazer backup dos arquivos do sistema WorkMesh',
        daemonJson: 'Fazer backup do arquivo de configuração do Docker',
        appData: 'Fazer backup dos aplicativos instalados do WorkMesh',
        panelData: 'Fazer backup do diretório de dados do WorkMesh',
        backupData: 'Fazer backup do diretório de backup local do WorkMesh',
        ...
        recoverHelper1: 'A recuperação requer reiniciar os serviços Docker e WorkMesh',
        recoverHelper2:
        ...
        rollback: 'Rollback',
        rollbackHelper:
            'Reverter essa recuperação substituirá todos os arquivos dessa recuperação e pode exigir reiniciar os serviços Docker e WorkMesh. Você deseja continuar?',
        upgradeHelper: 'A atualização requer reiniciar o serviço WorkMesh. Você deseja continuar?',
        rollbackLocalHelper:
            'O nó principal não suporta rollback direto. Por favor, execute manualmente o comando [wh restore] para fazer o rollback!',
    ...
    license: {
        ...
        node: 'Atualize para a edição comercial para gerenciar vários servidores Linux com o WorkMesh.',
        nodeApp:
        ...
        vllm: 'Atualize para a edição comercial para gerenciar serviços vLLM de forma centralizada no WorkMesh, incluindo implantação, configuração, operações de ciclo de vida e acompanhamento de tarefas.',
        'model-downloader':
    ...
    clean: {
        ...
        scanHelper: 'Limpeza fácil de arquivos inúteis gerados durante a execução do WorkMesh',
        clean: 'Limpar agora',
    ...
    ssl: {
        ...
        shellHelper:
            'O diretório padrão de execução do script é o diretório de instalação do WorkMesh. Se um certificado for enviado para o diretório local, o diretório de execução será o diretório de envio do certificado. O tempo limite padrão de execução é de 30 minutos.',
    ...
    firewall: {
        ...
        managedHelper: 'Criada e mantida pelo WorkMesh. Pode ser editada ou excluída.',
        adopted: 'Externa gerenciada',
        adoptedHelper: 'Uma regra existente do sistema que agora é mantida pelo WorkMesh.',
        external: 'Regra externa',
        externalHelper:
            'Regra existente do sistema que ainda não é gerenciada pelo WorkMesh. Pode ser adotada quando necessário.',
        ...
        adoptRuleConfirm: 'Depois disso, o WorkMesh poderá manter e excluir esta regra existente. Continuar?',
        ...
        plan_equivalent_managed_rule: 'Uma regra idêntica já é gerenciada pelo WorkMesh. Não é necessário duplicá-la.',
        ...
        scopeUnmanagedActive: 'Outros escopos ativos foram detectados: {0}. O WorkMesh não modificará suas regras.',
        ...
        dockerFirewallHelper: 'Seleciona como o WorkMesh gerencia a proteção de portas de contêineres.',
        ...
        resetDirectRulesHelper:
            'Exclua de {0} as cadeias, regras em execução e arquivos persistentes do firewall do WorkMesh; as políticas salvas no banco são mantidas',
        ...
        cleanupForwardingBackendHelper:
            'Redefina as regras de execução de encaminhamento de portas do WorkMesh em {0}: exclua todas as regras e cadeias relacionadas e mantenha os dados do banco de dados',
        cleanupDockerBackendHelper:
            'Redefina as regras de execução de proteção de portas Docker do WorkMesh em {0}: exclua todas as regras e cadeias relacionadas e mantenha os dados do banco de dados',
        cleanupBeforeBackendSwitch:
            'O backend atual {0} ainda contém regras de execução do WorkMesh. Redefina-o antes de mudar para {1}.',
        ...
        ruleSyncHelper:
            'Sincroniza as regras gerenciadas pelo WorkMesh do firewall selecionado para o firewall atual. As regras de origem não são excluídas e regras externas não são incluídas.',
        ruleSyncDatabase: 'Banco de dados do WorkMesh',
        ruleSyncDatabaseHelper:
            'Sincroniza e ajusta as regras gerenciadas no firewall atual com base nas regras do banco de dados do WorkMesh. As regras ausentes serão adicionadas e as excedentes serão removidas.',
    ...
    tool: {
        supervisor: {
            ...
            initWarn:
                'Isso irá modificar o valor "files" na seção "[include"] do arquivo de configuração principal. O diretório de outros arquivos de configuração será: "{diretório de instalação do WorkMesh}/workmesh/tools/supervisord/supervisor.d/".',
    ...
    xpack: {
        ...
        user: {
            ...
            auth: {
                ...
                oidc: {
                    ...
                    clockSkewHelper:
                        'Permite uma pequena diferença de horário entre o provedor de identidade e o WorkMesh. Mantenha o padrão de 60 segundos.',
                    ...
                    standardDiscoveryDesc: 'WorkMesh descobre endpoints e recursos e não armazena o documento bruto.',
                ...
                saml2: {
                    ...
                    nameAttributeHelper:
                        'Lê este atributo da asserção SAML verificada e o mapeia para o nome de usuário do WorkMesh.',
                    ...
                    syncLogoutHelper:
                        'Sair do WorkMesh ou do provedor de identidade também encerra a sessão do outro lado.',
                    testBeforeBrowserTest:
                        'Teste a configuração atual antes de iniciar um teste de login do navegador.',
                ...
                ldap: {
                    ...
                    userSearchDesc:
                        'Configure a base e o filtro de pesquisa e mapeie o atributo LDAP para o campo name do WorkMesh.',
                    ...
                    attributeMapTooltip: 'Mapeamento JSON do campo name do WorkMesh para um atributo LDAP.',
                    attributeMapHelper: 'Configure o atributo LDAP mapeado para o campo name do WorkMesh.',
                    advanced: 'Configurações avançadas',
                    ...
                    sync: {
                        ...
                        description:
                            'Leia o diretório LDAP completo de acordo com uma programação e mantenha os usuários LDAP importados em WorkMesh.',
                    ...
                    testLoginDesc:
                        'Vincule com uma credencial de usuário AD/LDAP apenas para testar a autenticação. Nenhuma sessão WorkMesh é criada.',
        ...
        waf: {
           WAF: 'WAF',
            time: 'Hora',
            runtimeUnavailable: 'O ambiente de execução do WAF está indisponível. Instale primeiro uma imagem OpenResty com ModSecurity e CRS.',
            name: 'WAF',
        ...
        helper: {
            ...
            settingContent1: 'Defina uma mensagem de boas-vindas personalizada na página de login do WorkMesh.',
            ...
            appContent1: 'Gerencie facilmente seu servidor WorkMesh a qualquer hora e em qualquer lugar.',
            ...
            vllmContent1:
                'Integre instâncias vLLM distribuídas ao WorkMesh e monitore versões, status operacional e diretórios de execução de forma centralizada.',
        ...
        node: {
            ...
            nodeUpgradePackageFormatHelper:
                'Somente pacotes de instalação `workmesh-agent_v*_*` ou `workmesh-v*-linux-*` são suportados',
            ...
            panelExist:
                'Detectado que este nó está executando o serviço WorkMesh V1. Atualize para V2 usando o script de migração antes de adicionar.',
            coreExist:
            ...
            agentExist:
                'Detectado que workmesh-agent já está instalado neste nó. Continuar irá reter os dados existentes e apenas substituir o serviço workmesh-agent.',
            agentNotExist:
                'Foi detectado que o workmesh-agent não está instalado neste nó, portanto, as informações do nó não podem ser editadas diretamente. Por favor, exclua e adicione novamente.',
            oldDataExist:
                'Detectados dados históricos do WorkMesh V2 neste nó. As seguintes informações serão usadas para sobrescrever as configurações atuais:',
            ...
            fixStatus: 'Execute "systemctl status workmesh-agent.service" para verificar se o serviço está em execução.',
            ...
            uninstallHelper: 'Isso excluirá todos os dados relacionados ao WorkMesh do nó. Escolha com cuidado!',
        ...
        customApp: {
            ...
            imagePrefixHelper:
                'Função: Personalize o prefixo da imagem e modifique o campo de imagem no arquivo compose. Por exemplo, quando o prefixo da imagem é configurado como workmesh/custom, o campo de imagem do MaxKB mudará para workmesh/custom/maxkb:v1.10.0',
