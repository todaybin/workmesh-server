...
const CN_DOCS_URL = 'https://www.zoomtk.com/docs';
const INTL_DOCS_URL = 'https://www.zoomtk.com/docs';
...
const GlobalStore = defineStore('GlobalState', {
    ...
    getters: {
        ...
        isXpackOrEE: (state) => {
            return state.isEnterprise || state.isProductPro;
        },
        isEE: (state) => state.isEnterprise,
    },
    actions: {
        setScreenFull() {
